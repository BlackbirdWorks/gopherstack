...
// TestFileStore_Save_SyncError and TestFileStore_Save_DirSyncError live in
// whitebox_test.go: they need direct access to the unexported
// fileSyncFn/dirSyncFn fields to simulate Sync() failures.
