...
func (m *mockAWSProvider) GetIoTAnalyticsHandler() service.Registerable            { return nil }
func (m *mockAWSProvider) GetKafkaHandler() service.Registerable                   { return nil }
func (m *mockAWSProvider) GetKinesisAnalyticsV2Handler() service.Registerable      { return nil }
...
func (m *mockAWSProvider) GetSsoAdminHandler() service.Registerable                { return nil }
...
func (m *mockAWSProvider) GetGlobalConfig() *globalcfg.GlobalConfig {
	return globalcfg.NewGlobalConfig("000000000000", "us-east-1", 0, 0, false, 0)
}
