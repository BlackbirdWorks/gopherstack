...
req := httptest.NewRequest(http.MethodPost, "/", strings.NewReader("Action=CreateCluster&Version=2012-12-01"))
...
req2 := httptest.NewRequest(http.MethodPost, "/", strings.NewReader("Action=DescribeClusters&ClusterIdentifier=my-cluster"))
