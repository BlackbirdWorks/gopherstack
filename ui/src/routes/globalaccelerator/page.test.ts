...
describe("GlobalAccelerator Page", () => {
  ...
  it("displays loaded accelerators", async () => {
    mockSend.mockResolvedValueOnce({
      Accelerators: [
        {
          AcceleratorArn: "arn:aws:ga:us-east-1:123:accelerator/abc",
          Name: "prod-accelerator",
          Status: "DEPLOYED",
        },
        {
          AcceleratorArn: "arn:aws:ga:us-east-1:123:accelerator/def",
  ...
  it("creates an accelerator via the modal form", async () => {
    ...
    mockSend.mockResolvedValueOnce({
      Accelerators: [{ AcceleratorArn: "arn:3", Name: "new-accel", Status: "DEPLOYED" }],
    });
