<script lang="ts">
	...
	const supportedOperations = [
		...
		'CreateDomainName', 'DeleteDomainName', 'GetDomainName', 'GetDomainNames',
		'CreateApiMapping', 'DeleteApiMapping', 'GetApiMapping', 'GetApiMappings',
		'CreateVpcLink', 'DeleteVpcLink', 'GetVpcLink', 'GetVpcLinks', 'UpdateVpcLink',
		'CreateIntegrationResponse', 'DeleteIntegrationResponse', 'GetIntegrationResponse', 'GetIntegrationResponses',
		'CreateModel', 'DeleteModel', 'GetModel', 'GetModels', 'UpdateModel',
		'CreateRouteResponse', 'DeleteRouteResponse', 'GetRouteResponse', 'GetRouteResponses',
