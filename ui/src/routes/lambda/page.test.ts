...
describe('Lambda Page', () => {
	...
	it('displays loaded functions', async () => {
		mockSend.mockResolvedValueOnce({
			Functions: [
				{ FunctionName: 'my-handler', FunctionArn: 'arn:1', Runtime: 'nodejs20.x', MemorySize: 128 },
				{ FunctionName: 'api-processor', FunctionArn: 'arn:2', Runtime: 'python3.12', MemorySize: 256 }
			]
		});
