...
export const sidebarCategories: DashboardCategory[] = [
  ...
  },
  {
    ...
    routes: [
      ...
      { id: "timestream", href: "/dashboard/timestream", label: "Timestream Write", icon: "timestream" },
      { id: "timestreamquery", href: "/dashboard/timestreamquery", label: "Timestream Query", icon: "timestream" },
