...
func verifyAdogAccount(ctx context.Context, t *testing.T, cfg aws.Config) {
	t.Helper()
...
func verifyAdogDirectConnect(ctx context.Context, t *testing.T, cfg aws.Config) {
	t.Helper()
...
func verifyAdogOpsWorks(ctx context.Context, t *testing.T, cfg aws.Config) {
	t.Helper()
...
func verifyAdogGrafana(ctx context.Context, t *testing.T, cfg aws.Config) {
	t.Helper()
	...
	tests := []tfTestCase{
		{
			...
			verify: func(t *testing.T, ctx context.Context, _ map[string]any) {
				...
				verifyAdogAccount(ctx, t, cfg)
				verifyAdogDirectConnect(ctx, t, cfg)
				verifyAdogOpsWorks(ctx, t, cfg)
				verifyAdogGrafana(ctx, t, cfg)
			},
		},
	}
