...
// loadGoModVersions parses go.mod via golang.org/x/mod/modfile and returns
// the pinned version of every aws-sdk-go-v2/service/* requirement, keyed by
// module name -- same approach as cmd/enumcheck, cmd/zeroguard and
// cmd/checkpins.
...
// service packages never import the typed SDK client in non-test code and
// only pin the module through their *_test.go round-trip clients. Same
// approach as cmd/enumcheck and cmd/zeroguard's resolveServiceModules.
