...
func TestRoute53ResolverHandler(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
		...
		{
			name: "CreateResolverEndpoint_InvalidJSON",
			run: func(t *testing.T) {
				h := newTestHandler(t)
		...
		{
			name: "DeleteResolverEndpoint_InvalidJSON",
			run: func(t *testing.T) {
				h := newTestHandler(t)
		...
		{
			name: "GetResolverEndpoint_InvalidJSON",
			run: func(t *testing.T) {
				h := newTestHandler(t)
		...
		{
			name: "CreateResolverRule_InvalidJSON",
			run: func(t *testing.T) {
				h := newTestHandler(t)
		...
		{
			name: "GetResolverRule_InvalidJSON",
			run: func(t *testing.T) {
				h := newTestHandler(t)
		...
		{
			name: "DeleteResolverRule_InvalidJSON",
			run: func(t *testing.T) {
				h := newTestHandler(t)
		...
		{
			name: "GetSupportedOperations_ContainsGetResolverRule",
			run: func(t *testing.T) {
				h := newTestHandler(t)
				ops := h.GetSupportedOperations()
