...
// TestTypedSlice15RealClient drives networkmanager's typed-coverage-blind
// ops (gopherstack-n3zi slice 15) through the real aws-sdk-go-v2 client.
func TestTypedSlice15RealClient(t *testing.T) {
	t.Parallel()

	t.Run("device site link lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("connect attachment and transit gateway connect peer associations", func(t *testing.T) {
		t.Parallel()
