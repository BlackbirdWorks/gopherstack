...
// TestTypedSlice7RealClient drives 57 of dms's 86 typed-coverage-blind ops
// (gopherstack-n3zi slice 7) through the real aws-sdk-go-v2 databasemigrationservice
...
func TestTypedSlice7RealClient(t *testing.T) {
	...
	t.Run("replication_instance_and_subnet_group", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("endpoints_connections", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("event_subscriptions", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("replication_configs_serverless", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("migration_project_family", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("data_migrations", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("assessments", func(t *testing.T) {
		t.Parallel()
		...
		// StartReplicationTaskAssessment requires the task to have already run once
		// and be stopped (InvalidResourceStateFault otherwise); start then stop it.
		...
		assert.Equal(t, runArn, aws.ToString(runsOut.ReplicationTaskAssessmentRuns[0].ReplicationTaskAssessmentRunArn))
		...
		require.NoError(t, err)
		assert.Equal(t, runArn, aws.ToString(cancelOut.ReplicationTaskAssessmentRun.ReplicationTaskAssessmentRunArn))
	...
	t.Run("fleet_advisor", func(t *testing.T) {
		t.Parallel()
		...
		schemasOut, err := client.DescribeFleetAdvisorSchemas(t.Context(), &dmssdk.DescribeFleetAdvisorSchemasInput{})
		require.NoError(t, err)
		...
		dbsOut, err := client.DescribeFleetAdvisorDatabases(t.Context(), &dmssdk.DescribeFleetAdvisorDatabasesInput{})
		require.NoError(t, err)
	...
	t.Run("replication_task_lifecycle", func(t *testing.T) {
		t.Parallel()
		...
		statusOut, err := client.DescribeRefreshSchemasStatus(t.Context(), &dmssdk.DescribeRefreshSchemasStatusInput{
			EndpointArn: srcOut.Endpoint.EndpointArn,
		})
		require.NoError(t, err)
	...
	t.Run("misc_account_and_maintenance", func(t *testing.T) {
		t.Parallel()
