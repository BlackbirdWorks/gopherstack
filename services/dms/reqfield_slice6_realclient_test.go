...
// Test_Slice6_ResourceIdentifier drives CreateEndpoint/CreateReplicationInstance/
// CreateReplicationTask's ResourceIdentifier field (reqfielddiff slice 6,
...
// response parameter").
func Test_Slice6_ResourceIdentifier(t *testing.T) {
	t.Parallel()

	t.Run("create_endpoint_uses_resource_identifier_in_arn", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("create_replication_instance_uses_resource_identifier_in_arn", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("create_replication_task_uses_resource_identifier_in_arn", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("resource_identifier_omitted_falls_back_to_generated_value", func(t *testing.T) {
		t.Parallel()
...
// Test_Slice6_DescribeReplicationTasksWithoutSettings proves
...
func Test_Slice6_DescribeReplicationTasksWithoutSettings(t *testing.T) {
	t.Parallel()
...
// Test_Slice6_StartReplicationTaskAssessmentRunResultEncryptionMode proves
...
func Test_Slice6_StartReplicationTaskAssessmentRunResultEncryptionMode(t *testing.T) {
	t.Parallel()
	...
	t.Run("defaults_to_sse_s3", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("honors_sse_kms", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("rejects_invalid_mode", func(t *testing.T) {
		...
		_, err := client.StartReplicationTaskAssessmentRun(t.Context(), &dmssdk.StartReplicationTaskAssessmentRunInput{
			ReplicationTaskArn:   aws.String(taskArn),
			ServiceAccessRoleArn: aws.String("arn:aws:iam::000000000000:role/dms-assess"),
			ResultLocationBucket: aws.String("dms-assess-bucket"),
