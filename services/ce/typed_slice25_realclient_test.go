...
// TestCE_TypedSlice25 drives every remaining uncovered op through a real
...
func TestCE_TypedSlice25(t *testing.T) {
	t.Parallel()

	t.Run(
		"cost category: tags, DeleteCostCategoryDefinition, ListCostCategoryResourceAssociations",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"anomaly family: UpdateAnomalyMonitor, DeleteAnomalySubscription, ProvideAnomalyFeedback",
		func(t *testing.T) {
			t.Parallel()
			...
			// An explicit SubscriptionArnList naming a deleted subscription
			// correctly hard-fails (UnknownSubscriptionException) rather than
			// returning an empty list -- confirmed against this package's own
			// GetAnomalySubscriptions/anomalySubscriptionARNSet behavior.
	...
	t.Run(
		"reservations: GetReservationPurchaseRecommendation, GetReservationUtilization",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run(
		"savings plans: GetSavingsPlanPurchaseRecommendationDetails, GetSavingsPlansPurchaseRecommendation",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run("cost usage and forecast family", func(t *testing.T) {
		t.Parallel()
	...
	t.Run(
		"cost allocation tags: ListCostAllocationTags, UpdateCostAllocationTagsStatus",
		func(t *testing.T) {
			t.Parallel()
