...
// TestSlice8_SecurityHub_RealClient covers securityhub's highest-priority
// typed-client-uncovered op families (gopherstack-n3zi slice 8): hub v1/v2
...
// response values.
func TestSlice8_SecurityHub_RealClient(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{testSlice8HubV2RealClient, "hub_v2"},
		{testSlice8StandardsControlsRealClient, "standards_controls"},
		{testSlice8SecurityControlsRealClient, "security_controls"},
		{testSlice8OrganizationRealClient, "organization"},
		{testSlice8MembersInvitationsRealClient, "members_invitations"},
		{testSlice8AutomationRulesRealClient, "automation_rules"},
		{testSlice8ConfigurationPoliciesRealClient, "configuration_policies"},
		{testSlice8FindingAggregatorsRealClient, "finding_aggregators"},
		{testSlice8ConnectorsRealClient, "connectors"},
		{testSlice8AggregatorsV2RealClient, "aggregators_v2"},
		{testSlice8ProductsRealClient, "products"},
		{testSlice8FindingsMiscRealClient, "findings_misc"},
	}
...
func newSlice8SecurityHubBackendAndClient(
	t *testing.T,
...
func testSlice8HubV2RealClient(t *testing.T) {
	t.Helper()
...
func testSlice8StandardsControlsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8SecurityControlsRealClient(t *testing.T) {
	t.Helper()

	_, client := newSlice8SecurityHubBackendAndClient(t)
	ctx := t.Context()
...
func testSlice8MembersInvitationsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8AutomationRulesRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8ConfigurationPoliciesRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8FindingAggregatorsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8AggregatorsV2RealClient(t *testing.T) {
	t.Helper()
...
func testSlice8ProductsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8FindingsMiscRealClient(t *testing.T) {
	t.Helper()
