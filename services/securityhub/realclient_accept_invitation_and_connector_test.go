...
// TestRealClient_AcceptInvitationAndConnector covers securityhub's last two typed-
// client-uncovered ops (gopherstack-n3zi): the deprecated
// AcceptInvitation and UpdateConnectorV2.
func TestRealClient_AcceptInvitationAndConnector(t *testing.T) {
	t.Parallel()
