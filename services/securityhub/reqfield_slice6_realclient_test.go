...
// Test_Slice6_EnableSecurityHubControlFindingGenerator proves EnableSecurityHub's
// ControlFindingGenerator (reqfielddiff slice 6, gopherstack-xhu2t; dropped:
// undeclared, hardcoded to SECURITY_CONTROL) is honored and round-trips
// through DescribeHub.
func Test_Slice6_EnableSecurityHubControlFindingGenerator(t *testing.T) {
	t.Parallel()

	t.Run("honors_standard_control", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("defaults_to_security_control", func(t *testing.T) {
		t.Parallel()
...
// Test_Slice6_OrganizationAdminAccountFeature proves Enable/DisableOrganizationAdminAccount's
// Feature (reqfielddiff slice 6, gopherstack-xhu2t; dropped: undeclared, this
...
func Test_Slice6_OrganizationAdminAccountFeature(t *testing.T) {
	t.Parallel()
...
// Test_Slice6_GetFindingStatisticsV2SortOrder proves GetFindingStatisticsV2's
// SortOrder (reqfielddiff slice 6, gopherstack-xhu2t; dropped: undeclared,
...
func Test_Slice6_GetFindingStatisticsV2SortOrder(t *testing.T) {
	t.Parallel()
...
// Test_Slice6_BatchUpdateFindingsVerificationState confirms
...
func Test_Slice6_BatchUpdateFindingsVerificationState(t *testing.T) {
	t.Parallel()
