...
// TestSlice7_PutPlaybackConfiguration_InsertionModeDefault covers
// gopherstack-xhu2t slice 7: PutPlaybackConfigurationInput.InsertionMode
...
func TestSlice7_PutPlaybackConfiguration_InsertionModeDefault(t *testing.T) {
	t.Parallel()
...
// TestSlice7_CreatePrefetchSchedule_StreamId proves CreatePrefetchScheduleInput.StreamId
...
func TestSlice7_CreatePrefetchSchedule_StreamId(t *testing.T) {
	t.Parallel()
