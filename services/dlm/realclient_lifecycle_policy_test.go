...
// TestRealClient_LifecyclePolicy covers dlm's last three typed-client-uncovered
// ops (gopherstack-n3zi): GetLifecyclePolicies, GetLifecyclePolicy,
// UpdateLifecyclePolicy.
func TestRealClient_LifecyclePolicy(t *testing.T) {
	t.Parallel()
	ctx := t.Context()
