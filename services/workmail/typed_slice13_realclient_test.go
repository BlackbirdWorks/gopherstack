...
// TestTypedSlice13WorkMailRealClient drives every op the census still
...
func TestTypedSlice13WorkMailRealClient(t *testing.T) {
	t.Parallel()
	...
	t.Run("availability_config", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("identity_center_and_provider", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("mobile_device_access_rules", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("mobile_device_access_overrides", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("personal_access_tokens", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("email_monitoring", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("mail_domain_default", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("mailbox_extras", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("entities_groups", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("users_misc", func(t *testing.T) {
		t.Parallel()
