...
No retrieval-path behavior exists to gate on ZIP-vs-BUCKET_PREFIX (SourceUrl content
is never fetched/parsed), and no output field echoes it. See items_still_open.
