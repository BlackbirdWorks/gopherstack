...
// createRealClientProject creates a minimal LINUX_CONTAINER project (optionally
// with a batch-capable buildspec) and returns its name and ARN.
func createRealClientProject(
	t *testing.T,
...
func TestReportGroupAndReportLifecycle_RealClient(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "ListReportGroups", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "ListReports", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "ListReportsForReportGroup", run: func(t *testing.T) {
			t.Helper()

			listed, listErr := client.ListReportsForReportGroup(
				t.Context(),
				&codebuildsdk.ListReportsForReportGroupInput{
		...
		{name: "GetReportGroupTrend", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "UpdateReportGroup", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "DeleteReport", run: func(t *testing.T) {
			t.Helper()
...
func TestBuildBatchAndBuildLifecycle_RealClient(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "build batch lifecycle", run: func(t *testing.T) {
			t.Helper()

			backend := codebuild.NewInMemoryBackend("000000000000", "us-east-1")
			client := newTestCodeBuildClient(t, codebuild.NewHandler(backend))

			projectName, _ := createRealClientProject(
			...
			_, delErr := client.DeleteBuildBatch(
				t.Context(),
				&codebuildsdk.DeleteBuildBatchInput{Id: aws.String(batchID)},
			)
			require.NoError(t, delErr)
		...
		{name: "build lifecycle", run: func(t *testing.T) {
			t.Helper()

			backend := codebuild.NewInMemoryBackend("000000000000", "us-east-1")
			client := newTestCodeBuildClient(t, codebuild.NewHandler(backend))

			projectName, _ := createRealClientProject(t, client, "slice34-build-proj", "")
...
func TestSandboxAndCommandExecutionLifecycle_RealClient(t *testing.T) {
	...
	projectName, _ := createRealClientProject(t, client, "slice34-sandbox-proj", "")
	...
	cases := []struct {
		...
		{name: "ListSandboxes", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "ListSandboxesForProject", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "StartSandboxConnection", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "BatchGetCommandExecutions + ListCommandExecutionsForSandbox", run: func(t *testing.T) {
			t.Helper()
			...
			ceProjectName, _ := createRealClientProject(t, ceClient, "slice34-ce-proj", "")
		...
		{name: "StopSandbox", run: func(t *testing.T) {
			t.Helper()
			...
			stopProjectName, _ := createRealClientProject(t, stopClient, "slice34-stop-proj", "")
...
func TestWebhookLifecycle_RealClient(t *testing.T) {
	...
	projectName, _ := createRealClientProject(t, client, "slice34-webhook-proj", "")
...
func TestResourcePolicyLifecycle_RealClient(t *testing.T) {
	...
	projectName, projectArn := createRealClientProject(t, client, "slice34-policy-proj", "")
	_ = projectName
...
func TestProjectVisibilityAndSharedProjects_RealClient(t *testing.T) {
	...
	_, projectArn := createRealClientProject(t, client, "slice34-visibility-proj", "")
...
func TestInvalidateProjectCache_RealClient(t *testing.T) {
	...
	projectName, _ := createRealClientProject(t, client, "slice34-cache-proj", "")
