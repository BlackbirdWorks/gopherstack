...
func TestBackend_CreateReplicationGroupFull_AlreadyExists(t *testing.T) {
	...
	_, err := b.CreateReplicationGroupFull(opts)
	require.NoError(t, err)
...
func TestBackend_ModifyReplicationGroupFull_ApplyImmediately(t *testing.T) {
	...
	rg, err := b.ModifyReplicationGroupFull("modify-imm-rg", elasticache.ReplicationGroupModifyOpts{
		EngineVersion:    "7.0.7",
...
func TestBackend_ModifyReplicationGroupFull_PendingChanges(t *testing.T) {
	...
	rg, err := b.ModifyReplicationGroupFull("modify-pending-rg", elasticache.ReplicationGroupModifyOpts{
		EngineVersion:    "7.0.7",
...
func TestBackend_ModifyReplicationGroupFull_AuthTokenRotate(t *testing.T) {
	...
	rg, err := b.ModifyReplicationGroupFull("auth-rotate-rg", elasticache.ReplicationGroupModifyOpts{
...
func TestBackend_ModifyReplicationGroupFull_AuthTokenDelete(t *testing.T) {
	...
	rg, err := b.ModifyReplicationGroupFull("auth-delete-rg", elasticache.ReplicationGroupModifyOpts{
...
func TestBackend_ModifyReplicationGroupFull_AuthTokenSet(t *testing.T) {
	...
	rg, err := b.ModifyReplicationGroupFull("auth-set-rg", elasticache.ReplicationGroupModifyOpts{
		AuthToken:               "new-token",
...
func TestBackend_ModifyReplicationGroupFull_TransitEncryptionMode(t *testing.T) {
	...
	rg, err := b.ModifyReplicationGroupFull("transit-mode-rg", elasticache.ReplicationGroupModifyOpts{
		TransitEncryptionMode:   "required",
...
func TestBackend_ModifyReplicationGroupFull_SnapshotRetentionLimit(t *testing.T) {
	...
	limit := 14
	rg, err := b.ModifyReplicationGroupFull("snap-ret-modify-rg", elasticache.ReplicationGroupModifyOpts{
...
func TestBackend_ModifyReplicationGroupFull_ReplicaCount(t *testing.T) {
	...
	rc := int32(3)
	rg, err := b.ModifyReplicationGroupFull("replica-count-rg", elasticache.ReplicationGroupModifyOpts{
		ReplicaCount:     &rc,
		ApplyImmediately: true,
	})
...
func TestBackend_ModifyReplicationGroupFull_NotFound(t *testing.T) {
	...
	_, err := b.ModifyReplicationGroupFull("nonexistent-rg", elasticache.ReplicationGroupModifyOpts{
...
func TestBackend_ModifyReplicationGroupFull_InvalidParamGroup(t *testing.T) {
	...
	_, err = b.ModifyReplicationGroupFull("pg-mod-rg", elasticache.ReplicationGroupModifyOpts{
		ParameterGroupName: "nonexistent-group",
	})
...
func TestBackend_TriggerAutoSnapshot_Success(t *testing.T) {
	...
	snap, err := b.TriggerAutoSnapshot("auto-snap-rg")
...
func TestBackend_TriggerAutoSnapshot_NotFound(t *testing.T) {
	...
	_, err := b.TriggerAutoSnapshot("nonexistent-rg")
...
func TestBackend_TriggerAutoSnapshot_PrunesOldSnapshots(t *testing.T) {
	...
	_, err = b.TriggerAutoSnapshot("prune-snap-rg")
	require.NoError(t, err)

	// Only 1 automated snapshot should remain.
	page, err := b.DescribeSnapshots("", "", "prune-snap-rg", "", 100)
	require.NoError(t, err)
...
func TestBackend_TriggerAutoSnapshot_DuplicateSameDay(t *testing.T) {
	...
	_, err = b.TriggerAutoSnapshot("dup-snap-rg")
	require.NoError(t, err)
...
func TestBackend_ModifyReplicationGroupShardConfiguration_RequiresClusterMode(t *testing.T) {
	...
	_, err = b.ModifyReplicationGroupShardConfiguration("no-cluster-rg", 2)
	require.Error(t, err)
...
func TestBackend_ModifyReplicationGroupShardConfiguration_WithClusterMode(t *testing.T) {
	...
	rg, err := b.ModifyReplicationGroupShardConfiguration("yes-cluster-rg", 4)
	require.NoError(t, err)
...
func TestBackend_CreateGlobalReplicationGroup_PrimaryRegion(t *testing.T) {
	...
	grg, err := b.CreateGlobalReplicationGroup("my-global", "global test", "grg-primary")
	require.NoError(t, err)
...
func TestBackend_UserGroup_AssignedReplicationGroupIDs(t *testing.T) {
	...
	ug, err := b.CreateUserGroup("ug1", "group 1", "redis", []string{"u1"})
	require.NoError(t, err)
...
func TestBackend_Persistence_NewFieldsRoundTrip(t *testing.T) {
	...
	page, err := b2.DescribeReplicationGroups("persist-rg", "", 0)
	require.NoError(t, err)
