...
func TestBatch4_ManagedPrefixList(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	var plID string

	t.Run("create prefix list", func(t *testing.T) {
	...
	t.Run("get entries returns added", func(t *testing.T) {
	...
	t.Run("delete prefix list", func(t *testing.T) {
	...
	t.Run("create with empty name returns error", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch4_ClientVpnEndpoint(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("describe returns endpoint", func(t *testing.T) {
		eps := b.DescribeClientVpnEndpoints([]string{epID})
		require.Len(t, eps, 1)
		assert.Equal(t, "10.0.0.0/22", eps[0].ClientCidrBlock)
	})

	t.Run("associate target network", func(t *testing.T) {
	...
	t.Run("disassociate target network", func(t *testing.T) {
		require.NoError(t, b.DisassociateClientVpnTargetNetwork(epID, "subnet-default"))
		networks, err := b.DescribeClientVpnTargetNetworks(epID)
		require.NoError(t, err)
	...
	t.Run("authorize ingress", func(t *testing.T) {
	...
	t.Run("revoke ingress", func(t *testing.T) {
	...
	t.Run("describe connections returns empty", func(t *testing.T) {
	...
	t.Run("apply security groups", func(t *testing.T) {
	...
	t.Run("create with empty cidr returns error", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch4_TGWPeeringAttachment(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	var attID string

	t.Run("create peering attachment", func(t *testing.T) {
	...
	t.Run("describe returns attachment", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch4_TGWConnect(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	var connectID, peerID string

	t.Run("create connect", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch4_TGWPrefixListReference(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("get references for route table", func(t *testing.T) {
	...
	t.Run("delete reference", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch4_VerifiedAccess(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("attach trust provider to instance", func(t *testing.T) {
		require.NoError(t, b.AttachVerifiedAccessTrustProvider(instanceID, trustProviderID))
		// double-attach is idempotent
		require.NoError(t, b.AttachVerifiedAccessTrustProvider(instanceID, trustProviderID))
	})

	t.Run("detach trust provider from instance", func(t *testing.T) {
	...
	t.Run("describe groups", func(t *testing.T) {
	...
	t.Run("describe endpoints", func(t *testing.T) {
	...
	t.Run("describe trust providers", func(t *testing.T) {
	...
	t.Run("delete trust provider", func(t *testing.T) {
	...
	t.Run("create group for non-existent instance still works", func(t *testing.T) {
		// Group creation doesn't validate instance existence in mock
		_, err := b.CreateVerifiedAccessGroup("vai-nonexistent", "group")
		require.NoError(t, err)
	})

	t.Run("attach to non-existent instance returns error", func(t *testing.T) {
