...
// TestSlice2_RealClient covers ec2's remaining uncovered-op families
// (gopherstack-n3zi slice 2): VPC Block Public Access, VPC peering,
...
func TestSlice2_RealClient(t *testing.T) {
	t.Parallel()
