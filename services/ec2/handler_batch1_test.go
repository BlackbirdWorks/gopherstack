...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_ModifyVolume(t *testing.T) {
	t.Parallel()
	...
	t.Run("resizes volume", func(t *testing.T) {
	...
	t.Run("empty volume ID returns error", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_DescribeVolumeStatus(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("returns ok status for known volume", func(t *testing.T) {
	...
	t.Run("returns all volumes when no filter", func(t *testing.T) {
		items := b.DescribeVolumeStatus(nil)
		assert.NotEmpty(t, items)
	})

	t.Run("filters to known IDs only", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_DescribeVolumesModifications(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("returns modification after ModifyVolume", func(t *testing.T) {
		mods := b.DescribeVolumesModifications([]string{vol.ID})
		require.Len(t, mods, 1)
		assert.Equal(t, "completed", mods[0].ModificationState)
	})

	t.Run("returns empty when no modifications", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_CopySnapshot(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("creates copy with new ID", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_CreateSnapshots(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("creates one snapshot per volume", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_SnapshotBlockPublicAccess(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("default state is block-all-sharing", func(t *testing.T) {
		assert.Equal(t, "block-all-sharing", b.GetSnapshotBlockPublicAccessState())
	})

	t.Run("enable sets block-new-sharing", func(t *testing.T) {
	...
	t.Run("disable sets unblocked", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_SnapshotTier(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("default tier is standard", func(t *testing.T) {
		items := b.DescribeSnapshotTierStatus([]string{snap.SnapshotID})
		require.Len(t, items, 1)
		assert.Equal(t, "standard", items[0].StorageTier)
	})

	t.Run("ModifySnapshotTier updates tier", func(t *testing.T) {
	...
	t.Run("ResetSnapshotAttribute clears attribute", func(t *testing.T) {
		require.NoError(t, b.ResetSnapshotAttribute(snap.SnapshotID))
	})

	t.Run("ModifySnapshotTier unknown snapshot returns error", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_CreateDefaultVpc(t *testing.T) {
	t.Parallel()

	t.Run("creates default vpc", func(t *testing.T) {
		b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("error when default vpc exists", func(t *testing.T) {
		b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
//nolint:tparallel // single subtest, parallel not needed
func TestBatch1_CreateDefaultSubnet(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_SubnetCIDRBlock(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("associate and disassociate", func(t *testing.T) {
...
func TestBatch1_SecurityGroupVpc(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("DescribeSecurityGroupReferences returns empty before association", func(t *testing.T) {
		refs := b.DescribeSecurityGroupReferences([]string{sg.ID})
		assert.Empty(t, refs)
	})

	t.Run("DescribeStaleSecurityGroups returns empty with no deleted peering", func(t *testing.T) {
		stale := b.DescribeStaleSecurityGroups("vpc-default")
		assert.Empty(t, stale)
	})

	t.Run("associate and describe", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_ModifyVpcTenancy(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("sets tenancy", func(t *testing.T) {
		require.NoError(t, b.ModifyVpcTenancy("vpc-default", "dedicated"))
	})

	t.Run("unknown vpc returns error", func(t *testing.T) {
		require.Error(t, b.ModifyVpcTenancy("vpc-missing", "default"))
	})
}

//nolint:tparallel // subtests share sequential state
func TestBatch1_ModifyVpcPeeringConnectionOptions(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_AddressAttribute(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	addr, _ := b.AllocateAddress()

	t.Run("modify and describe", func(t *testing.T) {
	...
	t.Run("reset clears domain name", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_GetConsoleOutput(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("returns base64 output for known instance", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_ModifyInstanceMetadataOptions(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("sets required tokens", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_InstanceMetadataDefaults(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("get returns default values", func(t *testing.T) {
		d := b.GetInstanceMetadataDefaults()
		assert.NotNil(t, d)
	})

	t.Run("modify updates values", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_InstanceCreditSpecifications(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
//nolint:tparallel // single subtest, parallel not needed
func TestBatch1_InstanceTopology(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_MonitorUnmonitorInstances(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("monitor sets enabled", func(t *testing.T) {
	...
	t.Run("unmonitor sets disabled", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_NetworkInterfaceAttribute(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	ni, _ := b.CreateNetworkInterface("subnet-default", "test NI")

	t.Run("describe returns description and sourceDestCheck", func(t *testing.T) {
		result, err := b.DescribeNetworkInterfaceAttribute(ni.ID, "description")
		require.NoError(t, err)
		assert.Equal(t, ni.ID, result.NetworkInterfaceID)
	})

	t.Run("reset sets sourceDestCheck to true", func(t *testing.T) {
		require.NoError(t, b.ResetNetworkInterfaceAttribute(ni.ID))
	})

	t.Run("unknown NI returns error", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch1_NetworkInterfacePermissions(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("describe returns created permission", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_IPv6Addresses(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	ni, _ := b.CreateNetworkInterface("subnet-default", "ipv6 NI")

	t.Run("assign IPv6 addresses", func(t *testing.T) {
		addrs, err := b.AssignIpv6Addresses(ni.ID, 2)
		require.NoError(t, err)
		require.Len(t, addrs, 2)
	})

	t.Run("unassign IPv6 addresses", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_DescribeAccountAttributes(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("returns all attributes when no filter", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_DescribePrefixLists(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("returns static prefix lists", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_IdFormat(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("describe returns default resources", func(t *testing.T) {
		items := b.DescribeIDFormat(nil)
		assert.NotEmpty(t, items)
	})

	t.Run("modify and describe shows change", func(t *testing.T) {
	...
	t.Run("describe aggregate returns all", func(t *testing.T) {
		items := b.DescribeAggregateIDFormat()
		assert.NotEmpty(t, items)
	})

	t.Run("identity format delegates to account format", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests use shared state
func TestBatch1_InstanceEventNotification(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("describe returns default", func(t *testing.T) {
		attrs := b.DescribeInstanceEventNotificationAttributes()
		assert.NotNil(t, attrs)
	})

	t.Run("deregister clears attributes", func(t *testing.T) {
...
// ---- HTTP dispatch integration tests ----

func TestBatch1_HTTP_ModifyVolume(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
...
func TestBatch1_HTTP_DescribeVolumeStatus(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
...
func TestBatch1_HTTP_CopySnapshot(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("123456789012", "us-east-1")
	h := ec2.NewHandler(b)
...
func TestBatch1_HTTP_GetSnapshotBlockPublicAccessState(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
...
func TestBatch1_HTTP_CreateDefaultVpc(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("123456789012", "us-east-1")
	h := ec2.NewHandler(b)
...
func TestBatch1_HTTP_DescribeAccountAttributes(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
...
func TestBatch1_HTTP_DescribePrefixLists(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
...
func TestBatch1_HTTP_GetConsoleOutput(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("123456789012", "us-east-1")
	h := ec2.NewHandler(b)
...
func TestBatch1_HTTP_MonitorInstances(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("123456789012", "us-east-1")
	h := ec2.NewHandler(b)
...
func TestBatch1_HTTP_DescribeIdFormat(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
