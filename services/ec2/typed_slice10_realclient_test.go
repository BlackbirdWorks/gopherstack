...
// TestSlice10_RealClient covers ec2's largest remaining uncovered-op
// families (gopherstack-n3zi slice 10): IPAM core/pool/resource-discovery/
...
func TestSlice10_RealClient(t *testing.T) {
	t.Parallel()
