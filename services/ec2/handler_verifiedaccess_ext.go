...
func registerVerifiedAccessExtOps(h *Handler, ops map[string]ec2ActionFn) {
...
// verifiedAccessExtSupportedOperations lists the operation names registered
// by registerVerifiedAccessExtOps, for GetSupportedOperations().
func verifiedAccessExtSupportedOperations() []string {
	return []string{
