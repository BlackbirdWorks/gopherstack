...
func TestBatch3_CapacityReservation(t *testing.T) {
	t.Parallel()
	...
	t.Run("modify instance count", func(t *testing.T) {
		require.NoError(t, b.ModifyCapacityReservation(crID, 5))
	})

	t.Run("get groups returns empty", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch3_InstanceConnectEndpoint(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("modify preserveClientIP", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch3_InstanceEventWindow(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	var ewID string

	t.Run("create window", func(t *testing.T) {
	...
	t.Run("describe returns window", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch3_SpotDatafeed(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("describe returns nil when empty", func(t *testing.T) {
		assert.Nil(t, b.DescribeSpotDatafeedSubscription())
	})

	t.Run("create datafeed", func(t *testing.T) {
		feed, err := b.CreateSpotDatafeedSubscription("my-bucket", "spot/")
		require.NoError(t, err)
		assert.Equal(t, "my-bucket", feed.Bucket)
	})

	t.Run("describe returns feed", func(t *testing.T) {
		feed := b.DescribeSpotDatafeedSubscription()
		require.NotNil(t, feed)
		assert.Equal(t, "spot/", feed.Prefix)
	})

	t.Run("delete removes feed", func(t *testing.T) {
...
func TestBatch3_RegisterImage(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("registers new AMI", func(t *testing.T) {
		t.Parallel()
...
func TestBatch3_ImportExportImage(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("import image creates task", func(t *testing.T) {
	...
	t.Run("describe import tasks returns all", func(t *testing.T) {
		tasks := b.DescribeImportImageTasks(nil)
		require.Len(t, tasks, 1)
	})

	t.Run("export image creates task", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch3_SnapshotRecycleBin(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("list empty recycle bin", func(t *testing.T) {
		snaps := b.ListSnapshotsInRecycleBin(nil)
		assert.Empty(t, snaps)
	})

	t.Run("import snapshot creates task", func(t *testing.T) {
...
// ---- Fast launch / snapshot restores ----

//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch3_FastLaunch(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	imageID := "ami-testfast"

	t.Run("enable fast launch", func(t *testing.T) {
	...
	t.Run("disable fast launch", func(t *testing.T) {
...
//nolint:tparallel,paralleltest // subtests share sequential state
func TestBatch3_FastSnapshotRestores(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("enable and describe", func(t *testing.T) {
	...
	t.Run("disable removes entry", func(t *testing.T) {
...
func TestBatch3_GetPasswordData(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	insts, _ := b.RunInstances("ami-test", "t3.micro", "", 1)

	t.Run("returns empty for instance", func(t *testing.T) {
		t.Parallel()
...
func TestBatch3_GetSecurityGroupsForVpc(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")

	t.Run("returns default SG for default VPC", func(t *testing.T) {
		t.Parallel()
...
func TestBatch3_ReplaceRoute(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
//nolint:tparallel // single subtest
func TestBatch3_GetInstanceTypesFromInstanceRequirements(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
//nolint:tparallel,paralleltest // subtests share state
func TestBatch3_VpnConnectionRoute(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	...
	t.Run("modify VPN connection", func(t *testing.T) {
...
//nolint:tparallel // single subtest
func TestBatch3_ModifyTransitGateway(t *testing.T) {
	t.Parallel()
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch3_HTTP_CreateCapacityReservation(t *testing.T) {
	t.Parallel()
...
func TestBatch3_HTTP_DescribeSpotDatafeedSubscription(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
...
func TestBatch3_HTTP_GetInstanceTypesFromInstanceRequirements(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
...
func TestBatch3_HTTP_DescribeFastSnapshotRestores(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
...
func TestBatch3_HTTP_ListSnapshotsInRecycleBin(t *testing.T) {
	t.Parallel()
	h := newTestHandler()
