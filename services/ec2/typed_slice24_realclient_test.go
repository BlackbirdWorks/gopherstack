...
// TestSlice24_RealClient covers ec2's next tier of uncovered ops
// (gopherstack-n3zi slice 24, descending walk): core instance lifecycle
...
func TestSlice24_RealClient(t *testing.T) {
	t.Parallel()
