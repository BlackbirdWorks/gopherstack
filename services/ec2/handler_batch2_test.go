...
func TestBatch2_VpcEndpointConnectionNotification(t *testing.T) { //nolint:paralleltest // existing issue.
...
func TestBatch2_VpcEndpointOperations(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_VpcEndpointServicePermissions(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_EbsEncryption(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_EnableVolumeIO(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_SnapshotLocking(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_CopyVolumes(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_DisassociateVpcCidrBlock(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_NatGatewayAddressOps(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_ImageLifecycle(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
	imageID := "ami-testimg"
...
func TestBatch2_DescribeInstanceImageMetadata(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_SerialConsole(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_VgwRoutePropagation(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_DefaultCreditSpecification(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_ReplaceRootVolumeTasks(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_AddressTransfers(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_SubnetCidrReservations(t *testing.T) { //nolint:paralleltest // existing issue.
	b := ec2.NewInMemoryBackend("000000000000", "us-east-1")
...
func TestBatch2_HTTP_GetEbsEncryptionByDefault(t *testing.T) { //nolint:paralleltest // existing issue.
	h := newTestHandler()
...
func TestBatch2_HTTP_GetSerialConsoleAccessStatus(t *testing.T) { //nolint:paralleltest // existing issue.
	h := newTestHandler()
...
func TestBatch2_HTTP_GetDefaultCreditSpecification(t *testing.T) { //nolint:paralleltest // existing issue.
	h := newTestHandler()
...
func TestBatch2_HTTP_DescribeVpcEndpointConnectionNotifications( //nolint:paralleltest // existing issue.
	t *testing.T,
) {
	h := newTestHandler()
...
func TestBatch2_HTTP_DescribeLockedSnapshots(t *testing.T) { //nolint:paralleltest // existing issue.
	h := newTestHandler()
...
func TestBatch2_HTTP_GetImageBlockPublicAccessState(t *testing.T) { //nolint:paralleltest // existing issue.
	h := newTestHandler()
...
func TestBatch2_HTTP_CreateSubnetCidrReservation(t *testing.T) { //nolint:paralleltest // existing issue.
