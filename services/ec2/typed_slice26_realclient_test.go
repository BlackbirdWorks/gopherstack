...
// TestSlice26_RealClient covers ec2's last tier of uncovered ops
// (gopherstack-n3zi slice 26): the Transit Gateway peripheral family
...
// handler+backend.
func TestSlice26_RealClient(t *testing.T) {
	t.Parallel()
