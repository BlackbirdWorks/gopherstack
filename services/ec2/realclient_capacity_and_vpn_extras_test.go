...
// TestRealClient_CapacityAndVPNExtras covers ec2's largest remaining uncovered-op
// families (gopherstack-n3zi): Capacity Reservation extras,
...
func TestRealClient_CapacityAndVPNExtras(t *testing.T) {
	t.Parallel()
