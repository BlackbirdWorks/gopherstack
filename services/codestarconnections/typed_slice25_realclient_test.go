...
// TestCodeStarConnections_TypedSlice25 drives every remaining uncovered op
...
func TestCodeStarConnections_TypedSlice25(t *testing.T) {
	t.Parallel()

	t.Run("host lifecycle: GetHost, ListHosts, DeleteHost", func(t *testing.T) {
		t.Parallel()
