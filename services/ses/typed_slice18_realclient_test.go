...
// newSlice18SESClient stands up a fresh backend/handler/client triple for
// gopherstack-n3zi typed slice 18.
func newSlice18SESClient(t *testing.T) *sessdk.Client {
	t.Helper()
...
// TestTypedSlice18SES_RealClient drives every op the census still listed as
...
func TestTypedSlice18SES_RealClient(t *testing.T) {
	t.Parallel()

	t.Run("identity_verification_and_dkim", func(t *testing.T) {
		t.Parallel()
		ctx := t.Context()
		client := newSlice18SESClient(t)
		...
		verAttrs, err := client.GetIdentityVerificationAttributes(ctx, &sessdk.GetIdentityVerificationAttributesInput{
		...
		_, err = client.SetIdentityFeedbackForwardingEnabled(ctx, &sessdk.SetIdentityFeedbackForwardingEnabledInput{
	...
	t.Run("identity_policies", func(t *testing.T) {
		t.Parallel()
		ctx := t.Context()
		client := newSlice18SESClient(t)
	...
	t.Run("verified_email_addresses_legacy", func(t *testing.T) {
		t.Parallel()
		ctx := t.Context()
		client := newSlice18SESClient(t)
	...
	t.Run("account_sending_and_quota", func(t *testing.T) {
		t.Parallel()
		ctx := t.Context()
		client := newSlice18SESClient(t)
	...
	t.Run("custom_verification_templates", func(t *testing.T) {
		t.Parallel()
		ctx := t.Context()
		client := newSlice18SESClient(t)

		_, err := client.CreateCustomVerificationEmailTemplate(ctx, &sessdk.CreateCustomVerificationEmailTemplateInput{
		...
		got, err := client.GetCustomVerificationEmailTemplate(ctx, &sessdk.GetCustomVerificationEmailTemplateInput{
			TemplateName: aws.String("slice18-cvt"),
		})
		require.NoError(t, err)
		assert.Equal(t, "verify@example.com", aws.ToString(got.FromEmailAddress))

		_, err = client.UpdateCustomVerificationEmailTemplate(ctx, &sessdk.UpdateCustomVerificationEmailTemplateInput{
			TemplateName:    aws.String("slice18-cvt"),
			TemplateSubject: aws.String("Please verify (updated)"),
		})
		require.NoError(t, err)

		updated, err := client.GetCustomVerificationEmailTemplate(ctx, &sessdk.GetCustomVerificationEmailTemplateInput{
			TemplateName: aws.String("slice18-cvt"),
		})
		require.NoError(t, err)
	...
	t.Run("templates_and_render", func(t *testing.T) {
		t.Parallel()
		ctx := t.Context()
		client := newSlice18SESClient(t)
	...
	t.Run("configuration_sets", func(t *testing.T) {
		t.Parallel()
		ctx := t.Context()
		client := newSlice18SESClient(t)
		...
		_, err = client.CreateConfigurationSetEventDestination(ctx, &sessdk.CreateConfigurationSetEventDestinationInput{
			ConfigurationSetName: aws.String("slice18-cs"),
		...
		_, err = client.UpdateConfigurationSetEventDestination(ctx, &sessdk.UpdateConfigurationSetEventDestinationInput{
			ConfigurationSetName: aws.String("slice18-cs"),
			EventDestination: &types.EventDestination{
				Name:               aws.String("slice18-dest"),
				Enabled:            false,
		...
		_, err = client.UpdateConfigurationSetSendingEnabled(ctx, &sessdk.UpdateConfigurationSetSendingEnabledInput{
			ConfigurationSetName: aws.String("slice18-cs"),
			Enabled:              false,
		})
		require.NoError(t, err)

		_, err = client.CreateConfigurationSetTrackingOptions(ctx, &sessdk.CreateConfigurationSetTrackingOptionsInput{
			ConfigurationSetName: aws.String("slice18-cs"),
			TrackingOptions:      &types.TrackingOptions{CustomRedirectDomain: aws.String("track.example.com")},
		})
		require.NoError(t, err)

		_, err = client.UpdateConfigurationSetTrackingOptions(ctx, &sessdk.UpdateConfigurationSetTrackingOptionsInput{
			ConfigurationSetName: aws.String("slice18-cs"),
			TrackingOptions:      &types.TrackingOptions{CustomRedirectDomain: aws.String("track2.example.com")},
		})
		require.NoError(t, err)
	...
	t.Run("receipt_rule_sets_and_rules", func(t *testing.T) {
		t.Parallel()
		ctx := t.Context()
		client := newSlice18SESClient(t)
	...
	t.Run("send_email_family", func(t *testing.T) {
		t.Parallel()
		ctx := t.Context()
		client := newSlice18SESClient(t)
