...
// newSlice9SSOAdminClient is a top-level (not closure-local) client
...
func newSlice9SSOAdminClient(t *testing.T) *ssoadminsdk.Client {
	t.Helper()
...
// TestTypedSlice9RealClient drives ssoadmin's typed-coverage-blind ops
// (gopherstack-n3zi slice 9) through the real aws-sdk-go-v2 ssoadmin client,
// one subtest per named priority family, asserting decoded values.
func TestTypedSlice9RealClient(t *testing.T) {
	t.Parallel()

	t.Run("permission set provisioning", func(t *testing.T) {
		t.Parallel()

		client := newSlice9SSOAdminClient(t)
	...
	t.Run("permission set policies", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("account assignments", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("application assignments", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("application access scopes", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("application authentication methods", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("application grants", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("trusted token issuers", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("instance access control attribute configuration", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("instance describe and update", func(t *testing.T) {
		t.Parallel()
