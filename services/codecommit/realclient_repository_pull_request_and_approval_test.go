...
func newRealClient(t *testing.T) *codecommitsdk.Client {
	t.Helper()
...
// TestRealClient_RepositoryLifecycle drives BatchGetRepositories,
// UpdateRepositoryName, UpdateRepositoryDescription, TagResource,
// UntagResource and ListTagsForResource.
func TestRealClient_RepositoryLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_BranchesAndCommits drives ListBranches, UpdateDefaultBranch
// and BatchGetCommits.
func TestRealClient_BranchesAndCommits(t *testing.T) {
	t.Parallel()
...
// TestRealClient_FilesAndBlob drives GetFile, GetFolder and GetBlob.
func TestRealClient_FilesAndBlob(t *testing.T) {
	t.Parallel()
...
// TestRealClient_MergeBranches drives GetMergeOptions, GetMergeCommit and
// MergeBranchesByFastForward.
func TestRealClient_MergeBranches(t *testing.T) {
	t.Parallel()
...
// TestRealClient_PullRequestLifecycle drives GetPullRequest,
...
func TestRealClient_PullRequestLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_MergePullRequestByThreeWayAndFastForward drives
// MergePullRequestByThreeWay and MergePullRequestByFastForward against fresh
// pull requests (each PR can only be merged once).
func TestRealClient_MergePullRequestByThreeWayAndFastForward(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ApprovalRuleTemplateLifecycle drives GetApprovalRuleTemplate,
...
func TestRealClient_ApprovalRuleTemplateLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_BatchApprovalRuleTemplateAssociation drives
// BatchAssociateApprovalRuleTemplateWithRepositories and
// BatchDisassociateApprovalRuleTemplateFromRepositories.
func TestRealClient_BatchApprovalRuleTemplateAssociation(t *testing.T) {
	t.Parallel()
...
// TestRealClient_RepositoryTriggers drives PutRepositoryTriggers,
// GetRepositoryTriggers and TestRepositoryTriggers.
func TestRealClient_RepositoryTriggers(t *testing.T) {
	t.Parallel()
...
// TestRealClient_CommentReactions drives PutCommentReaction and
...
func TestRealClient_CommentReactions(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ListPullRequestsFiltering drives ListPullRequests'
// pullRequestStatus filter.
func TestRealClient_ListPullRequestsFiltering(t *testing.T) {
	t.Parallel()
