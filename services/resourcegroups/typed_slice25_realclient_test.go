...
// TestResourceGroups_TypedSlice25 drives every remaining uncovered op
...
func TestResourceGroups_TypedSlice25(t *testing.T) {
	t.Parallel()

	t.Run("account settings get and update", func(t *testing.T) {
		t.Parallel()
	...
	t.Run(
		"group query and update: ListGroups, GetGroupQuery, UpdateGroup, UpdateGroupQuery",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run("group configuration: PutGroupConfiguration, GetGroupConfiguration", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("resources: GroupResources, ListGroupResources, SearchResources", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("tag sync task lifecycle: Start, Get, List, Cancel", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("Tag and Untag", func(t *testing.T) {
		t.Parallel()
