...
// TestSlice17_IoTAnalytics_RealClient covers iotanalytics's last four
// typed-client-uncovered ops (gopherstack-n3zi slice 17): TagResource,
...
func TestSlice17_IoTAnalytics_RealClient(t *testing.T) {
	t.Parallel()
	ctx := t.Context()
