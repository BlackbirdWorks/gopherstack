...
// TestSlice4_SageMaker_RealClient covers sagemaker's highest-priority
// typed-client-uncovered op families (gopherstack-n3zi slice 4): tags,
...
// response values.
func TestSlice4_SageMaker_RealClient(t *testing.T) {
	t.Parallel()
...
func newSlice4SageMakerClient(t *testing.T) *sagemakersdk.Client {
	t.Helper()
...
func testTagsExtraRealClient(t *testing.T) {
	...
	client := newSlice4SageMakerClient(t)
