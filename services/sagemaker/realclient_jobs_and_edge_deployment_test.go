...
// TestRealClient_JobsAndEdgeDeployment covers sagemaker's remaining
// typed-client-uncovered op families (gopherstack-n3zi): AI
...
func TestRealClient_JobsAndEdgeDeployment(t *testing.T) {
	t.Parallel()
