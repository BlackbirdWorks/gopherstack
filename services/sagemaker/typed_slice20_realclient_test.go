...
// TestSlice20_SageMaker_RealClient covers sagemaker's next-highest-priority
// typed-client-uncovered op families (gopherstack-n3zi slice 20): lineage
...
func TestSlice20_SageMaker_RealClient(t *testing.T) {
	t.Parallel()
...
func newSlice20SageMakerClient(t *testing.T) *sagemakersdk.Client {
	t.Helper()
...
func testLineageExtrasRealClient(t *testing.T) {
	...
	client := newSlice20SageMakerClient(t)
