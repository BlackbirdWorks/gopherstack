...
func toPersistedCluster(c *Cluster) *persistedCluster {
	pc := &persistedCluster{
		...
		RestrictedInstanceGroupsConfig: c.RestrictedInstanceGroupsConfig,
		Tags:                           c.Tags,
		InstanceGroups:                 c.InstanceGroups,
		RestrictedInstanceGroups:       c.RestrictedInstanceGroups,
...
func fromPersistedCluster(ctx context.Context, pc *persistedCluster) *Cluster {
	...
	c := &Cluster{
		...
		RestrictedInstanceGroupsConfig: pc.RestrictedInstanceGroupsConfig,
		Tags:                           pc.Tags,
		InstanceGroups:                 pc.InstanceGroups,
		RestrictedInstanceGroups:       pc.RestrictedInstanceGroups,
		CreationTime:                   t,
