...
// TestRealClient_CALifecyclePermissions drives acmpca's remaining
...
func TestRealClient_CALifecyclePermissions(t *testing.T) {
	t.Parallel()
	cases := []struct {
		run  func(t *testing.T)
		name string
	}{
		{name: "audit report lifecycle", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "CA certificate and CSR retrieval", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "permissions CRUD", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "resource policy CRUD", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "CA tags", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "delete and restore lifecycle", run: func(t *testing.T) {
			t.Helper()
			...
			assert.Equal(
				...
				descAfterRestore.CertificateAuthority.Status,
			)
		}}}
