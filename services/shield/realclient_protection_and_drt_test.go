...
// TestRealClient_ProtectionAndDRT drives every gopherstack-n3zi
// uncovered shield op through the real aws-sdk-go-v2 client.
func TestRealClient_ProtectionAndDRT(t *testing.T) {
	t.Parallel()
