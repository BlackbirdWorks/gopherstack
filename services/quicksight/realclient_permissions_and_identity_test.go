...
// TestRealClient_PermissionsAndIdentity covers quicksight's remaining
// typed-client-uncovered op families (gopherstack-n3zi): TopicV2,
...
func TestRealClient_PermissionsAndIdentity(t *testing.T) {
	t.Parallel()
