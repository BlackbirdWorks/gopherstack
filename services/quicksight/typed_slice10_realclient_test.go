...
// TestSlice10_QuickSight_RealClient covers quicksight's highest-priority
...
func TestSlice10_QuickSight_RealClient(t *testing.T) {
	t.Parallel()
...
// like slice3's data_sources/data_sets_extra setup.
...
// setup slice3's dashboards_extra subtest already established a pattern
// for).
