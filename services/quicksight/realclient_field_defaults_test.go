...
// TestRealClient_FieldDefaults proves, against the real typed
// aws-sdk-go-v2 quicksight client, that the 7 tier-1 findings this pass
// classified as DROPPED PARAMETER (gopherstack-xhu2t) are now read
...
func TestRealClient_FieldDefaults(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{testRegisterUserCustomPermissionsName, "register_user_custom_permissions_name"},
		{testUpdateUserCustomPermissionsName, "update_user_custom_permissions_name"},
		{testDeleteAnalysisRecoveryWindow, "delete_analysis_recovery_window_in_days"},
		{testUpdateCustomPermissionsGovernance, "update_custom_permissions_governance"},
		{testDashboardPublishOptions, "create_and_update_dashboard_publish_options"},
		{testGetDashboardEmbedURLNamespace, "get_dashboard_embed_url_namespace"},
	}
...
func testRegisterUserCustomPermissionsName(t *testing.T) {
	t.Helper()
...
func testUpdateUserCustomPermissionsName(t *testing.T) {
	t.Helper()
...
func testDeleteAnalysisRecoveryWindow(t *testing.T) {
	t.Helper()
...
func testUpdateCustomPermissionsGovernance(t *testing.T) {
	t.Helper()
...
func testDashboardPublishOptions(t *testing.T) {
	t.Helper()
...
func testGetDashboardEmbedURLNamespace(t *testing.T) {
	t.Helper()
