...
func sdkRouteCases() []struct{ op, method, path string } {
	return []struct{ op, method, path string }{
		...
		{"CreateApprovalPolicy", "POST", "/governance/approvalworkflows/policies"},
		...
		{"CreateDataSource", "POST", "/accounts/PLACEHOLDER/data-sources"},
		{
			"CreateDlpSetting",
			"POST",
			"/accounts/PLACEHOLDER/data-loss-prevention/settings/PLACEHOLDER",
		},
		...
		{"CreateLimitsProfile", "POST", "/governance/limits/accounts/PLACEHOLDER/profiles"},
		...
		{"DeleteApprovalPolicy", "DELETE", "/governance/approvalworkflows/policies/PLACEHOLDER"},
		...
		{"DeleteKnowledgeBase", "DELETE", "/v1/accounts/PLACEHOLDER/knowledge-bases/PLACEHOLDER"},
		{
			"DeleteLimitsProfile",
			"DELETE",
			"/governance/limits/accounts/PLACEHOLDER/profiles/PLACEHOLDER",
		},
		...
		{"DescribeApprovalPolicy", "GET", "/governance/approvalworkflows/policies/PLACEHOLDER"},
		...
		{"ListApprovalPolicies", "GET", "/governance/approvalworkflows/policies"},
		...
		{"ListDataSources", "GET", "/accounts/PLACEHOLDER/data-sources"},
		{
			"ListDlpSettings",
			"GET",
			"/accounts/PLACEHOLDER/data-loss-prevention/settings",
		},
		...
		{"ListKnowledgeBases", "GET", "/v1/accounts/PLACEHOLDER/knowledge-bases"},
		{
			"ListLimitsProfiles",
			"GET",
			"/governance/limits/accounts/PLACEHOLDER/profiles",
		},
		...
		{"UpdateApprovalPolicy", "PATCH", "/governance/approvalworkflows/policies/PLACEHOLDER"},
