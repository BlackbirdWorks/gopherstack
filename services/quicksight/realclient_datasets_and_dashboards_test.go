...
// TestRealClient_DatasetsAndDashboards covers quicksight's highest-priority
// typed-client-uncovered op families (gopherstack-n3zi): data
...
func TestRealClient_DatasetsAndDashboards(t *testing.T) {
	t.Parallel()
