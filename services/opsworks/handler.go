...
func (h *Handler) buildOps() map[string]service.JSONOpFunc {
	return map[string]service.JSONOpFunc{
		"CreateStack":         service.WrapOp(h.handleCreateStack),
		"DescribeStacks":      service.WrapOp(h.handleDescribeStacks),
		"UpdateStack":         service.WrapOp(h.handleUpdateStack),
		"DeleteStack":         service.WrapOp(h.handleDeleteStack),
		"CreateLayer":         service.WrapOp(h.handleCreateLayer),
		"DescribeLayers":      service.WrapOp(h.handleDescribeLayers),
		"UpdateLayer":         service.WrapOp(h.handleUpdateLayer),
		"DeleteLayer":         service.WrapOp(h.handleDeleteLayer),
		"CreateInstance":      service.WrapOp(h.handleCreateInstance),
		"DescribeInstances":   service.WrapOp(h.handleDescribeInstances),
		"UpdateInstance":      service.WrapOp(h.handleUpdateInstance),
		"DeleteInstance":      service.WrapOp(h.handleDeleteInstance),
		"StartInstance":       service.WrapOp(h.handleStartInstance),
		"StopInstance":        service.WrapOp(h.handleStopInstance),
		"RebootInstance":      service.WrapOp(h.handleRebootInstance),
		"CreateApp":           service.WrapOp(h.handleCreateApp),
		"DescribeApps":        service.WrapOp(h.handleDescribeApps),
		"UpdateApp":           service.WrapOp(h.handleUpdateApp),
		"DeleteApp":           service.WrapOp(h.handleDeleteApp),
		"CreateDeployment":    service.WrapOp(h.handleCreateDeployment),
		"DescribeDeployments": service.WrapOp(h.handleDescribeDeployments),
		"DescribeCommands":    service.WrapOp(h.handleDescribeCommands),
