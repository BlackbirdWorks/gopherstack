...
// TestTypedSlice11RealClient drives s3's remaining typed-client-blind ops
// through the real aws-sdk-go-v2 s3 client (gopherstack-n3zi typed slice 11).
...
func TestTypedSlice11RealClient(t *testing.T) {
	...
	t.Run("accelerate configuration", func(t *testing.T) {
		t.Parallel()
		...
		_, err = client.PutBucketAccelerateConfiguration(ctx, &sdk_s3.PutBucketAccelerateConfigurationInput{
			...
			AccelerateConfiguration: &types.AccelerateConfiguration{Status: types.BucketAccelerateStatusEnabled},
		})
		require.NoError(t, err)
	...
	t.Run("analytics configuration family", func(t *testing.T) {
		t.Parallel()
		...
		listOut, err := client.ListBucketAnalyticsConfigurations(ctx, &sdk_s3.ListBucketAnalyticsConfigurationsInput{
			Bucket: aws.String(bucket),
		})
		require.NoError(t, err)
		...
		listAfter, err := client.ListBucketAnalyticsConfigurations(ctx, &sdk_s3.ListBucketAnalyticsConfigurationsInput{
			Bucket: aws.String(bucket),
		})
		require.NoError(t, err)
	...
	t.Run("intelligent tiering configuration family", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("inventory configuration family", func(t *testing.T) {
		t.Parallel()
		...
		listOut, err := client.ListBucketInventoryConfigurations(ctx, &sdk_s3.ListBucketInventoryConfigurationsInput{
			Bucket: aws.String(bucket),
		})
		require.NoError(t, err)
		...
		listAfter, err := client.ListBucketInventoryConfigurations(ctx, &sdk_s3.ListBucketInventoryConfigurationsInput{
			Bucket: aws.String(bucket),
		})
		require.NoError(t, err)
	...
	t.Run("metrics configuration family", func(t *testing.T) {
		t.Parallel()
		...
		listOut, err := client.ListBucketMetricsConfigurations(ctx, &sdk_s3.ListBucketMetricsConfigurationsInput{
			Bucket: aws.String(bucket),
		})
		require.NoError(t, err)
		...
		listAfter, err := client.ListBucketMetricsConfigurations(ctx, &sdk_s3.ListBucketMetricsConfigurationsInput{
			Bucket: aws.String(bucket),
		})
		require.NoError(t, err)
	...
	t.Run("cors get and delete", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("lifecycle get and delete", func(t *testing.T) {
		t.Parallel()
		...
		_, err = client.DeleteBucketLifecycle(ctx, &sdk_s3.DeleteBucketLifecycleInput{Bucket: aws.String(bucket)})
		require.NoError(t, err)

		_, err = client.GetBucketLifecycleConfiguration(ctx, &sdk_s3.GetBucketLifecycleConfigurationInput{
			Bucket: aws.String(bucket),
		})
		assert.Error(t, err, "GetBucketLifecycleConfiguration after delete must fail (NoSuchLifecycleConfiguration)")
	})

	t.Run("bucket policy family", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("bucket notification configuration", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("bucket request payment", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("bucket location", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("object acl", func(t *testing.T) {
		t.Parallel()
		...
		require.NoError(t, err)
		require.NotEmpty(t, getOut.Grants, "a freshly-put object must have at least the owner FULL_CONTROL grant")
		...
		for _, g := range afterOut.Grants {
			if g.Grantee != nil && g.Grantee.URI != nil &&
				strings.Contains(aws.ToString(g.Grantee.URI), "AllUsers") && g.Permission == types.PermissionRead {
	...
	t.Run("object legal hold and retention", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("bucket object lock configuration", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("get object torrent", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("upload part copy", func(t *testing.T) {
		t.Parallel()
		...
		assert.NotEmpty(t, sum, "sanity: source data hashed for reference, not asserted against a fabricated checksum")
	...
	t.Run("update object encryption", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("list directory buckets is unreachable client-side (documented gap)", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("metadata table configuration get shape", func(t *testing.T) {
		t.Parallel()
		...
		_, err = client.CreateBucketMetadataTableConfiguration(ctx, &sdk_s3.CreateBucketMetadataTableConfigurationInput{
			Bucket: aws.String(bucket),
	...
	t.Run("delete bucket metadata configuration", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("write get object response via real client", func(t *testing.T) {
		t.Parallel()
		...
		lambdaFn := &typedWriteGetObjectResponseLambda{serverURL: lambdaServerURL, body: "lambda-typed-client-body"}
