...
type Settings struct {
	...
	CompressionMinBytes int           `json:"compression_min_bytes" env:"S3_COMPRESSION_MIN_BYTES" default:"1024"      help:"Minimum object size in bytes for gzip compression. Set to 0 to compress all objects regardless of size." name:"compression-min-bytes"` //nolint:lll // config struct tags are intentionally verbose
}
