...
// TestTypedSlice14Macie2RealClient drives every op the census still listed
// as uncovered before this pass (gopherstack-n3zi typed-client coverage
// slice 14). Each subtest builds its own fresh backend/client.
func TestTypedSlice14Macie2RealClient(t *testing.T) {
	t.Parallel()
	...
	t.Run("allow_list_lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("custom_data_identifier", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("findings_filter_lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("findings_publication_config", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("member_invitation", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("administrator_master", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("automated_discovery", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("classification_jobs", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("classification_export_config", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("classification_scope", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("reveal_configuration", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("managed_data_identifiers", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("resource_profile", func(t *testing.T) {
		t.Parallel()
