...
// TestTypedSlice14PersonalizeRealClient drives every op the census still
// listed as uncovered before this pass (gopherstack-n3zi typed-client
// coverage slice 14). Each subtest builds its own fresh backend/client.
func TestTypedSlice14PersonalizeRealClient(t *testing.T) {
	t.Parallel()
	...
	t.Run("dataset_lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("dataset_jobs", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("solution_lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("campaign_lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("event_tracker_lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("filter_lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("recommender_lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("metric_attribution_lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("batch_inference_job", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("batch_segment_job", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("data_deletion_job", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("recipe_algorithm_feature_transformation", func(t *testing.T) {
		t.Parallel()
