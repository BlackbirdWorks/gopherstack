...
// TestRealClient_DatasetJobAndScheduleLifecycle drives every remaining uncovered op through a
...
func TestRealClient_DatasetJobAndScheduleLifecycle(t *testing.T) {
	t.Parallel()
	cases := []struct {
		run  func(t *testing.T)
		name string
	}{
		{name: "dataset lifecycle: UpdateDataset, DeleteDataset", run: func(t *testing.T) {
			t.Helper()
		...
		{
			name: "recipe and job lifecycle: Update/DeleteRecipe, UpdateRecipeJob, ListJobs, StopJobRun, DeleteJob",
			run: func(t *testing.T) {
				t.Helper()
		...
		{
			name: "project lifecycle: UpdateProject, ListProjects, SendProjectSessionAction, DeleteProject",
			run: func(t *testing.T) {
				t.Helper()
		...
		{name: "schedule lifecycle: UpdateSchedule, ListSchedules, DeleteSchedule", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "ruleset lifecycle: UpdateRuleset, DeleteRuleset", run: func(t *testing.T) {
			t.Helper()
