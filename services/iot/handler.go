...
func (h *Handler) GetSupportedOperations() []string {
	...
	core = append(core,
		...
		opCreatePackageVersion, opGetPackageVersion, opUpdatePackageVersion, opDeletePackageVersion, opListPackageVersions,
		opGetPackageConfiguration, opUpdatePackageConfiguration,
		opCreateAuditSuppression, opDescribeAuditSuppression, opUpdateAuditSuppression, opDeleteAuditSuppression, opListAuditSuppressions,
		opDescribeAuditFinding, opListAuditFindings,
		opGetV2LoggingOptions, opSetV2LoggingOptions, opSetV2LoggingLevel, opDeleteV2LoggingLevel, opListV2LoggingLevels,
	...
	core = append(core,
		...
		opDescribeDetectMitigationActionsTask, opListDetectMitigationActionsTasks, opListDetectMitigationActionsExecutions,
