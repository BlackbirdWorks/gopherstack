...
// TestSlice4_IoT_RealClient covers iot's highest-priority typed-client-
// uncovered op families (gopherstack-n3zi slice 4): thing types, thing
// groups, certificates, CA certificates, policies, topic rules and
// destinations, jobs, commands, fleet indexing, provisioning, OTA/streams,
// security profiles/audit, mitigation actions, domain configurations,
// billing groups, role aliases, authorizers and tags. Each subtest creates
// real state through the typed aws-sdk-go-v2 client and asserts decoded
// response values.
func TestSlice4_IoT_RealClient(t *testing.T) {
	t.Parallel()
