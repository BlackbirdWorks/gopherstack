...
// TestRealClient_AuditAndMisc drives iot's audit, logging, and remaining
// misc op families (gopherstack-n3zi) through the real aws-sdk-go-v2
// client, asserting decoded response values: audit suppressions, account
// audit configuration, audit findings and related resources, audit/detect
...
func TestRealClient_AuditAndMisc(t *testing.T) {
	t.Parallel()
