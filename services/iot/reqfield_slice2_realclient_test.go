...
// newIoTTestClientWithBackend is newIoTTestClient (typed_slice4_realclient_test.go)
...
// TestReqFieldSlice2IoTJobForce drives CancelJob/CancelJobExecution/DeleteJob's
// Force fields (gopherstack-xhu2t slice 2 tier-1 findings) through the real
// SDK client. All three bind Force to an HTTP query parameter, not the body
// (confirmed against aws-sdk-go-v2/service/iot@v1.83.0's schemas.go) --
// CancelJobExecution previously read it from the body instead, a different
// bug class than a plain drop.
func TestReqFieldSlice2IoTJobForce(t *testing.T) {
	t.Parallel()

	t.Run("cancel_job_force_cascades_to_in_progress_executions", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("cancel_job_without_force_leaves_in_progress_execution_alone", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("cancel_job_execution_force_query_param_allows_canceling_in_progress", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("delete_job_force_query_param_allows_deleting_in_progress", func(t *testing.T) {
		t.Parallel()
...
// TestReqFieldSlice2IoTProvisioning drives CreateProvisioningTemplateVersion's
...
func TestReqFieldSlice2IoTProvisioning(t *testing.T) {
	t.Parallel()

	t.Run("create_provisioning_template_version_set_as_default_query_param", func(t *testing.T) {
		t.Parallel()
		...
		v, err := client.CreateProvisioningTemplateVersion(t.Context(), &iotsdk.CreateProvisioningTemplateVersionInput{
			TemplateName: aws.String("rfd2-tmpl"),
	...
	t.Run("domain_configuration_protocol_and_auth_type_round_trip", func(t *testing.T) {
		t.Parallel()
...
// TestReqFieldSlice2IoTCommandsFilterAndSort drives ListCommands'
...
// sortOrder).
func TestReqFieldSlice2IoTCommandsFilterAndSort(t *testing.T) {
	t.Parallel()

	t.Run("list_commands_namespace_filter_and_max_results", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("list_commands_sort_order", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("list_command_executions_sort_order", func(t *testing.T) {
		t.Parallel()
...
// TestReqFieldSlice2IoTListPagination drives the maxResults field on five
// List/Get ops that previously returned every item with no pagination at
// all (ListAuditTasks, ListMitigationActions, ListScheduledAudits,
// ListCustomMetrics) or decoded-but-never-applied it (ListAuditFindings).
func TestReqFieldSlice2IoTListPagination(t *testing.T) {
	t.Parallel()

	t.Run("list_audit_tasks_max_results", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("list_mitigation_actions_max_results", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("list_scheduled_audits_max_results", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("list_custom_metrics_max_results", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("list_audit_findings_max_results", func(t *testing.T) {
		t.Parallel()
...
// TestReqFieldSlice2IoTGetStatisticsIndexName drives GetStatistics'
// indexName (decoded but never read before this pass -- GetStatistics
// always aggregated the AWS_Things index regardless of what was requested)
// through the real SDK client, proving AWS_ThingGroups is now a genuinely
// distinct result set.
func TestReqFieldSlice2IoTGetStatisticsIndexName(t *testing.T) {
	t.Parallel()
...
// TestReqFieldSlice2IoTRegisterCACertificate drives RegisterCACertificate's
...
func TestReqFieldSlice2IoTRegisterCACertificate(t *testing.T) {
	t.Parallel()

	t.Run("sni_only_with_verification_certificate_is_rejected", func(t *testing.T) {
		t.Parallel()
		...
		_, err := client.RegisterCACertificate(t.Context(), &iotsdk.RegisterCACertificateInput{
			...
			VerificationCertificate: aws.String("-----BEGIN CERTIFICATE-----\nverify\n-----END CERTIFICATE-----"),
		})
		require.Error(t, err)
	})

	t.Run("default_mode_without_verification_certificate_is_rejected", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("default_mode_with_verification_certificate_succeeds_and_describes_back", func(t *testing.T) {
		t.Parallel()
