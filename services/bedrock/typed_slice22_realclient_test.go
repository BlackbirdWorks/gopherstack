...
// TestSlice22_BedrockAgents_RealClient drives every gopherstack-n3zi
// slice-22-uncovered AgentsHandler op (the bedrock-agent-shaped Agent/Flow/
...
func TestSlice22_BedrockAgents_RealClient(t *testing.T) {
	t.Parallel()
...
func newSlice22AgentClient(t *testing.T) *bedrockagentsdk.Client {
	t.Helper()
...
func testAgentLifecycleRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
...
func createSlice22Agent(t *testing.T, client *bedrockagentsdk.Client, name string) string {
	t.Helper()
...
func testAgentActionGroupRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
	agentID := createSlice22Agent(t, client, "slice22-ag-actiongroup")
...
func testAgentAliasRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
	agentID := createSlice22Agent(t, client, "slice22-ag-alias")
...
func testAgentCollaboratorRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
	agentID := createSlice22Agent(t, client, "slice22-ag-collab")
...
func createSlice22KnowledgeBase(t *testing.T, client *bedrockagentsdk.Client, name string) string {
	t.Helper()
...
func testAgentKnowledgeBaseRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
	agentID := createSlice22Agent(t, client, "slice22-ag-kb")
	kbID := createSlice22KnowledgeBase(t, client, "slice22-kb-for-agent")
...
func testDataSourceRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
	kbID := createSlice22KnowledgeBase(t, client, "slice22-kb-for-ds")

	dsID := createSlice22DataSource(t, client, kbID, "slice22-ds")
...
func testIngestionJobRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
	kbID := createSlice22KnowledgeBase(t, client, "slice22-kb-for-job")
	dsID := createSlice22DataSource(t, client, kbID, "slice22-ds-for-job")
...
func testKBDocumentsTypedRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
	kbID := createSlice22KnowledgeBase(t, client, "slice22-kb-for-docs")
	dsID := createSlice22DataSource(t, client, kbID, "slice22-ds-for-docs")
...
func createSlice22Flow(t *testing.T, client *bedrockagentsdk.Client, name string) string {
	t.Helper()
...
func testFlowAliasRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
	flowID := createSlice22Flow(t, client, "slice22-flow-for-alias")
...
func testFlowVersionRealClient(t *testing.T) {
	...
	client := newSlice22AgentClient(t)
	flowID := createSlice22Flow(t, client, "slice22-flow-for-version")
