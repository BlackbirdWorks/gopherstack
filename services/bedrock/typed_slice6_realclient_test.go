...
// TestSlice6_Bedrock_RealClient covers bedrock's highest-priority typed-
// client-uncovered op families named by gopherstack-n3zi slice 6: guardrail
...
func TestSlice6_Bedrock_RealClient(t *testing.T) {
	t.Parallel()
...
func newSlice6BedrockClient(t *testing.T) *bedrocksdk.Client {
	t.Helper()
...
func testGuardrailVersionsRealClient(t *testing.T) {
	...
	client := newSlice6BedrockClient(t)
