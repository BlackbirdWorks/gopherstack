...
// regardless of what version it was pointed at (gopherstack-n3zi).
// A prior typed-client test (realclient_agents_flows_and_knowledge_bases_test.go's
...
// 2026-09-12 entry and the PARITY.md note added alongside this
// change.
