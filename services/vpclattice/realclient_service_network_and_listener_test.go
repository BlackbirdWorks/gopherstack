...
func newRealClient(t *testing.T) *vpclatticesdk.Client {
	t.Helper()
...
// TestRealClient_ServiceNetworkLifecycle drives Get/UpdateServiceNetwork.
func TestRealClient_ServiceNetworkLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ServiceNetworkServiceAssociationLifecycle drives
// Get/DeleteServiceNetworkServiceAssociation.
func TestRealClient_ServiceNetworkServiceAssociationLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ServiceNetworkVpcAssociationLifecycle drives
// Get/Update/DeleteServiceNetworkVpcAssociation.
func TestRealClient_ServiceNetworkVpcAssociationLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ServiceNetworkResourceAssociationLifecycle drives
// Get/ListServiceNetworkResourceAssociations.
func TestRealClient_ServiceNetworkResourceAssociationLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ListenerLifecycle drives Get/Update/ListListeners and
// DeleteListener.
func TestRealClient_ListenerLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_RuleLifecycle drives Get/Update/ListRules, DeleteRule
// and BatchUpdateRule.
func TestRealClient_RuleLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_TargetGroupAndTargetsLifecycle drives
// Update/ListTargetGroups, DeleteTargetGroup, Register/Deregister/ListTargets.
func TestRealClient_TargetGroupAndTargetsLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_AccessLogSubscriptionLifecycle drives
// UpdateAccessLogSubscription and DeleteAccessLogSubscription.
func TestRealClient_AccessLogSubscriptionLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ResourcePolicy drives Get/PutResourcePolicy and
...
// TestRealClient_AuthPolicyDelete drives DeleteAuthPolicy.
func TestRealClient_AuthPolicyDelete(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ResourceConfigurationUpdate drives
// UpdateResourceConfiguration.
func TestRealClient_ResourceConfigurationUpdate(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ResourceGatewayUpdate drives UpdateResourceGateway.
func TestRealClient_ResourceGatewayUpdate(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ServiceUpdate drives UpdateService.
func TestRealClient_ServiceUpdate(t *testing.T) {
	t.Parallel()
...
// TestRealClient_DomainVerificationsList drives ListDomainVerifications.
func TestRealClient_DomainVerificationsList(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ResourceTags drives TagResource, UntagResource and
