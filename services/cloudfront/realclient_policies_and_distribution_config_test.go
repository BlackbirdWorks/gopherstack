...
// TestRealClient_PoliciesAndDistributionConfig covers cloudfront's highest-priority
// typed-client-uncovered op families (gopherstack-n3zi): cache/
...
func TestRealClient_PoliciesAndDistributionConfig(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{testCachePolicyRealClient, "cache_policy"},
		{testOriginRequestPolicyRealClient, "origin_request_policy"},
		{testResponseHeadersPolicyRealClient, "response_headers_policy"},
		{testOAIRealClient, "oai"},
		{testOACRealClient, "oac"},
		{testPublicKeyKeyGroupRealClient, "public_key_key_group"},
		{testFieldLevelEncryptionRealClient, "field_level_encryption"},
		{testContinuousDeploymentRealClient, "continuous_deployment"},
		{testFunctionRealClient, "function"},
		{testKeyValueStoreRealClient, "key_value_store"},
		{testInvalidationRealClient, "invalidation"},
		{testStreamingDistributionConfigRealClient, "streaming_distribution_config"},
		{testCopyAndStagingDistributionRealClient, "copy_and_staging_distribution"},
	}
...
func testCachePolicyRealClient(t *testing.T) {
	t.Helper()
...
func testOriginRequestPolicyRealClient(t *testing.T) {
	t.Helper()
...
func testResponseHeadersPolicyRealClient(t *testing.T) {
	t.Helper()
...
func testOAIRealClient(t *testing.T) {
	t.Helper()
...
func testOACRealClient(t *testing.T) {
	t.Helper()
...
func testPublicKeyKeyGroupRealClient(t *testing.T) {
	t.Helper()
...
func testFieldLevelEncryptionRealClient(t *testing.T) {
	t.Helper()
...
func testContinuousDeploymentRealClient(t *testing.T) {
	t.Helper()
...
func testFunctionRealClient(t *testing.T) {
	t.Helper()
...
func testKeyValueStoreRealClient(t *testing.T) {
	t.Helper()
...
func testInvalidationRealClient(t *testing.T) {
	t.Helper()
...
func testStreamingDistributionConfigRealClient(t *testing.T) {
	t.Helper()
...
func testCopyAndStagingDistributionRealClient(t *testing.T) {
	t.Helper()
