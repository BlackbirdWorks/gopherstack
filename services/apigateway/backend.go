...
// GetUsage returns real per-key usage data for a usage plan. Each item is keyed by
// API key ID and contains a [used, remaining] pair reflecting the requests the data
// plane has actually metered against the plan's quota.
