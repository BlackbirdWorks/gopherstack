...
// TestRealClient_GetDomainNameAccessAssociationsPagination covers
// gopherstack-xhu2t: GetDomainNameAccessAssociationsInput.Limit
...
func TestRealClient_GetDomainNameAccessAssociationsPagination(t *testing.T) {
	t.Parallel()
...
// TestRealClient_GetSdkTypesLimit covers gopherstack-xhu2t:
...
// SDK type catalog.
func TestRealClient_GetSdkTypesLimit(t *testing.T) {
	t.Parallel()
