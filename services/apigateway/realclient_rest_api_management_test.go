...
func newRealClient(t *testing.T) *apigwsdk.Client {
	t.Helper()

	return newTestAPIGatewayClient(t, apigateway.NewHandler(apigateway.NewInMemoryBackend()))
}

// TestRealClient_RESTAPIManagement drives apigateway's typed-coverage-blind
// ops (gopherstack-n3zi) through the real aws-sdk-go-v2 apigateway client,
// one case per named priority family, asserting decoded values.
func TestRealClient_RESTAPIManagement(t *testing.T) {
	t.Parallel()
	cases := []struct {
		run  func(t *testing.T)
		name string
	}{
		{name: "rest api lifecycle", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "resources and methods", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "authorizers", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "deployments and stages", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "models", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "request validators", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "gateway responses", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "usage plan keys", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "api keys", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "domain names and base path mappings", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "domain name access associations", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "vpc links", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "documentation", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "client certificates", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "sdk types", run: func(t *testing.T) {
			t.Helper()
