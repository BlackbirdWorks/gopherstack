...
func sdkRouteCases() []struct{ op, method, path string } {
	return []struct{ op, method, path string }{
		...
		{"GetTags", "GET", "/tags/arn:aws:apigateway:us-east-1::/restapis/PLACEHOLDER"},
		...
		{"TagResource", "PUT", "/tags/arn:aws:apigateway:us-east-1::/restapis/PLACEHOLDER"},
		...
		{"UntagResource", "DELETE", "/tags/arn:aws:apigateway:us-east-1::/restapis/PLACEHOLDER"},
