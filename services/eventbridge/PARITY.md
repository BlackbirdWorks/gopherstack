...
Implemented the 11 previously-notImplemented schemas ops: 7 Discoverer ops,
ExportSchema, and Get/Put/DeleteResourcePolicy (REST-JSON1, handler_schemas_rest.go
+ new discoverers.go/resource_policy.go). PutEvents now feeds a STARTED
discoverer via discoverSchemaLocked. Not persisted, matching sibling registries/schemas.
