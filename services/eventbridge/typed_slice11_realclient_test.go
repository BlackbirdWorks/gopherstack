...
// TestTypedSlice11RealClient drives eventbridge's typed-coverage-blind ops
...
func TestTypedSlice11RealClient(t *testing.T) {
	...
	t.Run("api destination lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("archive delete and update", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("endpoint delete and describe", func(t *testing.T) {
		t.Parallel()
		...
		_, err := client.CreateEventBus(ctx, &eventbridgesdk.CreateEventBusInput{Name: aws.String("s11-ep-primary")})
		require.NoError(t, err)
		_, err = client.CreateEventBus(ctx, &eventbridgesdk.CreateEventBusInput{Name: aws.String("s11-ep-secondary")})
		require.NoError(t, err)
	...
	t.Run("rule enable disable and test event pattern", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("partner event source lifecycle", func(t *testing.T) {
		t.Parallel()
		...
		require.NoError(t, err)
		assert.Equal(t, ebtypes.EventSourceStatePending, afterDeactivate.State,
