...
**Parity grade: A** · SDK `aws-sdk-go-v2/service/swf@v1.37.4` · last audited 2026-08-10 (`pending (agent instructed not to commit; see git log for this pass's commit)`)
