...
func TestAccessAnalyzerHandler_RouteMatcher(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "tags_access_analyzer_arn", path: "/tags/arn:aws:access-analyzer:us-east-1:000000000000:analyzer/my-analyzer", wantMatch: true},
		...
		{name: "tags_fis_arn", path: "/tags/arn:aws:fis:us-east-1:000000000000:experiment-template/EXTabcdef", wantMatch: false},
		{name: "tags_fis_experiment", path: "/tags/arn:aws:fis:us-east-1:000000000000:experiment/EXPabcdef", wantMatch: false},
		{name: "tags_guardduty_arn", path: "/tags/arn:aws:guardduty:us-east-1:000000000000:detector/abc123", wantMatch: false},
		{name: "tags_kinesis_arn", path: "/tags/arn:aws:kinesis:us-east-1:000000000000:stream/my-stream", wantMatch: false},
