...
func newTestSlice33AppConfigHandler() *appconfig.Handler {
...
// TestSlice33_AppConfig_RealClient drives every gopherstack-n3zi
// typed-slice-33 uncovered appconfig op through the real aws-sdk-go-v2
// client (newTestAppConfigClient, shared with handler_error_type_test.go).
func TestSlice33_AppConfig_RealClient(t *testing.T) {
	t.Parallel()
...
func testDeploymentStrategiesRealClient(t *testing.T) {
	...
	h := newTestSlice33AppConfigHandler()
