...
// TestRealClient_AppVersionAndResources drives resiliencehub's remaining
...
// UpdateAppVersion.
func TestRealClient_AppVersionAndResources(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{
			name: "app version and app component",
			run: func(t *testing.T) {
				t.Helper()
