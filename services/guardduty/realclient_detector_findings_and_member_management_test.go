...
// for gopherstack-n3zi.
func newRealClient(t *testing.T) *guarddutysdk.Client {
	t.Helper()
...
// createRealClientDetector creates an enabled detector via the real client and
// returns its ID.
func createRealClientDetector(t *testing.T, client *guarddutysdk.Client) string {
	t.Helper()
...
// TestRealClient_DetectorFindingsAndMemberManagement drives every op the census still
// listed as uncovered before this pass (gopherstack-n3zi typed-client
// coverage).
func TestRealClient_DetectorFindingsAndMemberManagement(t *testing.T) {
	t.Parallel()
	cases := []struct {
		run  func(t *testing.T)
		name string
	}{
		{name: "detector_and_org_family", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "findings_family", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "ip_threatintel_delete_family", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "entity_sets_family", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "publishing_destination_family", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "malware_protection_family", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "members_family", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "invitations_admin_family", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "investigations_family", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "coverage_and_trial_family", run: func(t *testing.T) {
			t.Helper()
