...
func newRealClient(t *testing.T) *apigatewayv2sdk.Client {
	t.Helper()
...
// TestRealClient_APIManagement drives apigatewayv2's typed-coverage-blind ops
// (gopherstack-n3zi) through the real aws-sdk-go-v2 apigatewayv2
// client, one subtest per named priority family, asserting decoded values.
func TestRealClient_APIManagement(t *testing.T) {
	t.Parallel()
	cases := []struct {
		...
		{name: "integration responses", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "route responses", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "deployments and domain names", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "delete settings families", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "routing rules", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "portals", run: func(t *testing.T) {
			t.Helper()
