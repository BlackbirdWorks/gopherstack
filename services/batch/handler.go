...
func (h *Handler) WithJanitor(interval, inactiveJobDefTTL time.Duration, taskTimeout ...time.Duration) *Handler {
	j := NewJanitor(h.Backend, interval, inactiveJobDefTTL)
