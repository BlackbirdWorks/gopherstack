...
func TestDeregisterJobDefinition_MarksInactive(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			jd, err := backend.RegisterJobDefinition("my-job", "container", nil, nil, 0)
...
func TestDeregisterJobDefinition_RevisionCounterPreserved(t *testing.T) {
	...
	jd1, err := backend.RegisterJobDefinition("my-job", "container", nil, nil, 0)
	require.NoError(t, err)
	...
	jd2, err := backend.RegisterJobDefinition("my-job", "container", nil, nil, 0)
	require.NoError(t, err)
...
func TestBatchJanitor_SweepInactiveJobDefinitions(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			jd, err := backend.RegisterJobDefinition("sweep-job", "container", nil, nil, 0)
			require.NoError(t, err)
