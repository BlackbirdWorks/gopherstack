...
last_audit_date: 2026-09-19  # prior: 2026-09-19 -- 2026-09-19 over-wide-response sweep (gopherstack, see Notes) re-verified ListConsumableResources/ListJobsByConsumableResource/ListServiceJobs/ListJobs member-by-member against batch@v1.68.4
...
despite Job storing all three -- fixed. ListConsumableResources/
ListJobsByConsumableResource/ListServiceJobs already matched their real
summary types exactly. See list_summary_shapes_test.go.
