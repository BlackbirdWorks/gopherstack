...
// TestResourceCreator_DependentServiceTypes_NilBackends ensures all phase-3 resource types return a stub
// physical ID when the corresponding backend is nil.
func TestResourceCreator_DependentServiceTypes_NilBackends(t *testing.T) {
	t.Parallel()
...
// TestResourceCreator_DependentServiceTypes_RealBackends validates create and delete
// for all phase-3 resource types with real in-memory backends.
func TestResourceCreator_DependentServiceTypes_RealBackends(t *testing.T) {
	t.Parallel()
...
// EFSMountTargetAfterFileSystem verifies mount target creation
// succeeds when the file system exists first.
func TestResourceCreator_EFSMountTargetAfterFileSystem(t *testing.T) {
	t.Parallel()
...
// BatchJobQueueWithCE verifies job queue creation
// succeeds when a compute environment exists.
func TestResourceCreator_BatchJobQueueWithCE(t *testing.T) {
	t.Parallel()
...
func TestResourceCreator_EKSNodegroupAfterCluster(t *testing.T) {
	t.Parallel()
...
func TestResourceCreator_APIGatewayV2StageAfterAPI(t *testing.T) {
	t.Parallel()
...
func TestResourceCreator_DocDBInstanceAfterCluster(t *testing.T) {
	t.Parallel()
...
// succeeds when a cluster exists.
func TestResourceCreator_NeptuneInstanceAfterCluster(t *testing.T) {
	t.Parallel()
...
func TestResourceCreator_AutoScalingGroupStringSizes(t *testing.T) {
	t.Parallel()
