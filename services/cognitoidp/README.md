...
**Parity grade: A** · SDK `aws-sdk-go-v2/service/cognitoidentityprovider@1.67.0` · last audited 2026-07-25 (`pending (uncommitted this pass -- see git log at merge time)`)
