...
// TestRealClient_ManagedLoginAndProvisioning covers cognitoidp's remaining 32
// typed-client-uncovered ops (gopherstack-n3zi), grouped by shared
...
func TestRealClient_ManagedLoginAndProvisioning(t *testing.T) {
	t.Parallel()
