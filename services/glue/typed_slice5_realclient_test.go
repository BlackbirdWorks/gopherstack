...
// TestSlice5_Glue_RealClient covers glue's highest-priority typed-client-
// uncovered op families (gopherstack-n3zi slice 5): tables/partitions,
...
func TestSlice5_Glue_RealClient(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{testSlice5PartitionsRealClient, "partitions"},
		{testSlice5TableVersionsRealClient, "table_versions"},
		{testSlice5CrawlersRealClient, "crawlers"},
		{testSlice5ClassifiersRealClient, "classifiers"},
		{testSlice5JobsBookmarksRealClient, "jobs_bookmarks"},
		{testSlice5TriggersRealClient, "triggers"},
		{testSlice5WorkflowsRealClient, "workflows"},
		{testSlice5ConnectionsRealClient, "connections"},
		{testSlice5DevEndpointsRealClient, "dev_endpoints"},
		{testSlice5SessionsRealClient, "sessions_statements"},
		{testSlice5SchemaRegistryRealClient, "schema_registry"},
		{testSlice5DataQualityRealClient, "data_quality"},
		{testSlice5MLTransformsRealClient, "ml_transforms"},
		{testSlice5BlueprintsRealClient, "blueprints"},
		{testSlice5ResourcePolicyRealClient, "resource_policy"},
		{testSlice5CatalogSecurityRealClient, "catalog_security"},
		{testSlice5CatalogsRealClient, "catalogs"},
		{testSlice5ColumnStatisticsRealClient, "column_statistics"},
...
func newSlice5GlueClient(t *testing.T) *gluesdk.Client {
	t.Helper()
...
func testSlice5PartitionsRealClient(t *testing.T) {
	t.Helper()

	client := newSlice5GlueClient(t)
	ctx := t.Context()
...
func testSlice5TableVersionsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5CrawlersRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5ClassifiersRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5JobsBookmarksRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5TriggersRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5WorkflowsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5ConnectionsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5DevEndpointsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5SessionsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5SchemaRegistryRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5DataQualityRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5MLTransformsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5BlueprintsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5ResourcePolicyRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5CatalogSecurityRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5CatalogsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice5ColumnStatisticsRealClient(t *testing.T) {
	t.Helper()
