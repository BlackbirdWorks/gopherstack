...
// TestRealClient_CatalogScopingAndFieldFixes proves the gopherstack-xhu2t
...
func TestRealClient_CatalogScopingAndFieldFixes(t *testing.T) {
	t.Parallel()
...
func newFieldFixesRealClient(t *testing.T) *gluesdk.Client {
	t.Helper()
...
func testCatalogIDDatabaseScoping(t *testing.T) {
	...
	client := newFieldFixesRealClient(t)
	ctx := t.Context()
