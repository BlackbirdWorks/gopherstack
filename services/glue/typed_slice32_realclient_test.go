...
// TestSlice32Glue_GlossaryLifecycle drives Create/Get/UpdateGlossary,
// ListGlossaries, CreateGlossaryTerm, GetGlossaryTerm, and
// Associate/DisassociateGlossaryTerms.
func TestSlice32Glue_GlossaryLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_AssetTypeAndFormTypeLifecycle drives PutFormType/GetFormType/
// ListFormTypes, PutAssetType/GetAssetType/ListAssetTypes.
func TestSlice32Glue_AssetTypeAndFormTypeLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_AssetAndAttachmentLifecycle drives GetAsset, UpdateAsset,
// SearchAssets, PutAttachment, DeleteAttachment, BatchGetIterableForms and
// ListIterableForms.
func TestSlice32Glue_AssetAndAttachmentLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_CustomEntityTypeLifecycle drives Create/Get/
// DeleteCustomEntityType and BatchGetCustomEntityTypes.
func TestSlice32Glue_CustomEntityTypeLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_TableOptimizerLifecycle drives UpdateTableOptimizer,
// ListTableOptimizerRuns and DeleteTableOptimizer.
func TestSlice32Glue_TableOptimizerLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_UsageProfileDelete drives DeleteUsageProfile.
func TestSlice32Glue_UsageProfileDelete(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_IdentityCenterConfigDelete drives
// DeleteGlueIdentityCenterConfiguration.
func TestSlice32Glue_IdentityCenterConfigDelete(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_DashboardUrl drives GetDashboardUrl.
func TestSlice32Glue_DashboardUrl(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_ETLScriptGeneration drives CreateScript, GetDataflowGraph,
// GetMapping and GetPlan.
func TestSlice32Glue_ETLScriptGeneration(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_DescribeEntity drives DescribeEntity (through the
...
func TestSlice32Glue_DescribeEntity(t *testing.T) {
	t.Parallel()
...
// TestSlice32Glue_DeleteTableVersion drives DeleteTableVersion.
func TestSlice32Glue_DeleteTableVersion(t *testing.T) {
	t.Parallel()
