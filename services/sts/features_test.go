...
func TestAssumeRole_ExternalID_RoleLookupError_Fails(t *testing.T) {
	t.Parallel()

	// When the role cannot be found in the lookup, AssumeRole should fail
	// with ErrNoSuchEntity.
	backend := sts.NewInMemoryBackend()
