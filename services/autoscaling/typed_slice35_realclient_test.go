...
// TestTypedSlice35RealClient drives autoscaling's typed-coverage-blind ops
...
func TestTypedSlice35RealClient(t *testing.T) {
	...
	t.Run("instance lifecycle", func(t *testing.T) {
		...
		termOut, err := client.TerminateInstanceInAutoScalingGroup(ctx, &assdk.TerminateInstanceInAutoScalingGroupInput{
			InstanceId:                     aws.String("i-s35-attach1"),
			ShouldDecrementDesiredCapacity: aws.Bool(true),
		})
		require.NoError(t, err)
	...
	t.Run("notifications", func(t *testing.T) {
		...
		descOut, err := client.DescribeNotificationConfigurations(ctx, &assdk.DescribeNotificationConfigurationsInput{
			AutoScalingGroupNames: []string{groupName},
		})
		require.NoError(t, err)
		...
		descOut2, err := client.DescribeNotificationConfigurations(ctx, &assdk.DescribeNotificationConfigurationsInput{
			AutoScalingGroupNames: []string{groupName},
		})
		require.NoError(t, err)
	...
	t.Run("scheduled actions", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("scaling policies", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("instance refresh cancel and rollback", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("process management and describe types", func(t *testing.T) {
		t.Parallel()
		...
		termTypesOut, err := client.DescribeTerminationPolicyTypes(ctx, &assdk.DescribeTerminationPolicyTypesInput{})
		require.NoError(t, err)
