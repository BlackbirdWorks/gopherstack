...
ops:
  ...
  PutRepositoryPermissionsPolicy: {wire: ok, errors: fixed, state: ok, persist: ok, note: "FIXED (gopherstack-6flj) — same required-PolicyDocument gap as PutDomainPermissionsPolicy"}
