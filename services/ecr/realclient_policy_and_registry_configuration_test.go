...
// TestRealClient_PolicyAndRegistryConfiguration drives ecr's typed-coverage-blind ops
// (gopherstack-n3zi) through the real aws-sdk-go-v2 client.
func TestRealClient_PolicyAndRegistryConfiguration(t *testing.T) {
	t.Parallel()
	cases := []struct {
		...
		{name: "account settings and pull time exclusions", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "registry policy", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "repository policy", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "lifecycle policy", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "pull through cache rule", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "repository creation template", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "layer upload lifecycle", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "batch get image and list referrers", run: func(t *testing.T) {
			t.Helper()
