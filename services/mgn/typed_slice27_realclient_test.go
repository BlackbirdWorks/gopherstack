...
// TestTypedSlice27RealClient drives mgn's remaining typed-client-blind ops
// through the real aws-sdk-go-v2 client (gopherstack-n3zi typed slice 27).
func TestTypedSlice27RealClient(t *testing.T) {
	t.Parallel()

	t.Run("application archive unarchive update", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("wave archive unarchive update", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("source server replication lifecycle", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("import file enrichment start and list", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("network migration mapper segment constructs and mapping update", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("network migration deployments listing", func(t *testing.T) {
		t.Parallel()
