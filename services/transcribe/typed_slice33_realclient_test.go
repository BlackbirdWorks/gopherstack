...
// TestSlice33_Transcribe_RealClient drives every gopherstack-n3zi
// typed-slice-33 uncovered transcribe op through the real aws-sdk-go-v2
// client (newTranscribeSDKClient, shared with wire_field_fixes_g8k9_test.go).
func TestSlice33_Transcribe_RealClient(t *testing.T) {
	t.Parallel()
