...
// TestSlice32_NamespaceLifecycle drives Create/Get/List/Update/DeleteNamespace
// through the real redshiftserverless client (typed slice 32, gopherstack-n3zi).
func TestSlice32_NamespaceLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32_WorkgroupLifecycle drives Create/Get/List/Update/DeleteWorkgroup.
func TestSlice32_WorkgroupLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32_GetCredentials proves GetCredentials returns a decoded
// DbUser/DbPassword/Expiration/NextRefreshTime that a real client can read.
func TestSlice32_GetCredentials(t *testing.T) {
	t.Parallel()
...
// TestSlice32_SnapshotLifecycle drives Create/Get/List/Update/DeleteSnapshot.
func TestSlice32_SnapshotLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32_UsageLimitGetListUpdate covers Get/List/UpdateUsageLimit
// (Create/Delete are already typed-covered elsewhere).
func TestSlice32_UsageLimitGetListUpdate(t *testing.T) {
	t.Parallel()
...
// TestSlice32_ScheduledActionGetListUpdate covers Get/List/UpdateScheduledAction.
...
func TestSlice32_ScheduledActionGetListUpdate(t *testing.T) {
	t.Parallel()
...
// TestSlice32_CustomDomainGetListUpdate covers Get/List/UpdateCustomDomainAssociation
// (Create/Delete already typed-covered elsewhere).
func TestSlice32_CustomDomainGetListUpdate(t *testing.T) {
	t.Parallel()
...
// TestSlice32_EndpointAccessGetListUpdate covers Get/List/UpdateEndpointAccess
...
func TestSlice32_EndpointAccessGetListUpdate(t *testing.T) {
	t.Parallel()
...
// TestSlice32_ListManagedWorkgroups proves the honest-empty-list shape decodes
...
func TestSlice32_ListManagedWorkgroups(t *testing.T) {
	t.Parallel()
...
// TestSlice32_SnapshotCopyConfigLifecycle covers Create/Update/Delete/List
// SnapshotCopyConfiguration.
func TestSlice32_SnapshotCopyConfigLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32_RecoveryPointsAndRestore covers Get/ListRecoveryPoint and
...
func TestSlice32_RecoveryPointsAndRestore(t *testing.T) {
	t.Parallel()
...
// TestSlice32_RestoreFromSnapshot covers RestoreFromSnapshot.
func TestSlice32_RestoreFromSnapshot(t *testing.T) {
	t.Parallel()
...
// TestSlice32_TableRestoreLifecycle covers RestoreTableFromSnapshot,
// RestoreTableFromRecoveryPoint, GetTableRestoreStatus, ListTableRestoreStatus.
func TestSlice32_TableRestoreLifecycle(t *testing.T) {
	t.Parallel()
...
// TestSlice32_ConvertRecoveryPointToSnapshot covers
// ConvertRecoveryPointToSnapshot.
func TestSlice32_ConvertRecoveryPointToSnapshot(t *testing.T) {
	t.Parallel()
...
// TestSlice32_Tracks covers GetTrack and ListTracks against the fixed
// current/trailing catalog.
func TestSlice32_Tracks(t *testing.T) {
	t.Parallel()
...
// TestSlice32_UpdateLakehouseConfiguration covers UpdateLakehouseConfiguration,
// including its flat (non-enveloped) response shape and DryRun behavior.
func TestSlice32_UpdateLakehouseConfiguration(t *testing.T) {
	t.Parallel()
...
// TestSlice32_ResourceTags covers TagResource, UntagResource and
// ListTagsForResource against a real namespace ARN.
func TestSlice32_ResourceTags(t *testing.T) {
	t.Parallel()
