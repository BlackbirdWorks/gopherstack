...
// TestSlice5_Redshift_RealClient covers redshift's highest-priority typed-
// client-uncovered classic-Redshift op families (gopherstack-n3zi slice 5):
...
func TestSlice5_Redshift_RealClient(t *testing.T) {
	t.Parallel()
