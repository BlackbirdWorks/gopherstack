...
func TestBackend_ModifyClusterSnapshot(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			setup: func(b *redshift.InMemoryBackend) {
				_, _ = b.CreateCluster("c2", "dc2.large", "dev", "admin", nil, "", redshift.CreateClusterOptions{})
		...
		},
		{
			...
			setup: func(b *redshift.InMemoryBackend) {
				_, _ = b.CreateCluster("c3", "dc2.large", "dev", "admin", nil, "", redshift.CreateClusterOptions{})
