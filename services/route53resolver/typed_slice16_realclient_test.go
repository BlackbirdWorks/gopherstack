...
// slice16Policy builds a minimal, valid resource-sharing policy document for
// the Put*Policy ops' request bodies.
func slice16Policy(action, resourceARN string) string {
	return fmt.Sprintf(
...
// newSlice16Route53ResolverClient stands up a fresh backend/handler/client
// triple for gopherstack-n3zi typed slice 16.
func newSlice16Route53ResolverClient(t *testing.T) *route53resolversdk.Client {
	t.Helper()
...
// TestTypedSlice16Route53ResolverRealClient drives every op the census
// still listed as uncovered before this pass (gopherstack-n3zi typed-client
// coverage slice 16).
func TestTypedSlice16Route53ResolverRealClient(t *testing.T) {
	t.Parallel()

	t.Run("firewall_domain_list_family", func(t *testing.T) {
		t.Parallel()

		client := newSlice16Route53ResolverClient(t)

		created, err := client.CreateFirewallDomainList(t.Context(), &route53resolversdk.CreateFirewallDomainListInput{
		...
		listedDomains, err := client.ListFirewallDomains(t.Context(), &route53resolversdk.ListFirewallDomainsInput{
			FirewallDomainListId: aws.String(listID),
		})
		require.NoError(t, err)
	...
	t.Run("firewall_rule_group_family", func(t *testing.T) {
		t.Parallel()
		...
		_, err = client.PutFirewallRuleGroupPolicy(t.Context(), &route53resolversdk.PutFirewallRuleGroupPolicyInput{
			Arn: aws.String(groupARN),
			FirewallRuleGroupPolicy: aws.String(
				slice16Policy("route53resolver:GetFirewallRuleGroup", groupARN),
			),
		})
		require.NoError(t, err)
	...
	t.Run("firewall_rule_family", func(t *testing.T) {
		t.Parallel()
		...
		listedTypes, err := client.ListFirewallRuleTypes(t.Context(), &route53resolversdk.ListFirewallRuleTypesInput{})
		require.NoError(t, err)
	...
	t.Run("firewall_rule_batch_family", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("resolver_config_family", func(t *testing.T) {
		t.Parallel()
		...
		assert.Equal(t, types.ResolverAutodefinedReverseStatusDisabled, updated.ResolverConfig.AutodefinedReverse)
	...
	t.Run("dnssec_config_family", func(t *testing.T) {
		t.Parallel()
		...
		got, err := client.GetResolverDnssecConfig(t.Context(), &route53resolversdk.GetResolverDnssecConfigInput{
			ResourceId: aws.String(vpcID),
		})
		require.NoError(t, err)
	...
	t.Run("firewall_config_family", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("resolver_endpoint_family", func(t *testing.T) {
		t.Parallel()
		...
		listedIPs, err := client.ListResolverEndpointIpAddresses(
			t.Context(),
			&route53resolversdk.ListResolverEndpointIpAddressesInput{ResolverEndpointId: aws.String(endpointID)},
		)
		require.NoError(t, err)
		...
		updated, err := client.UpdateResolverEndpoint(t.Context(), &route53resolversdk.UpdateResolverEndpointInput{
			ResolverEndpointId: aws.String(endpointID),
	...
	t.Run("outpost_resolver_family", func(t *testing.T) {
		t.Parallel()

		client := newSlice16Route53ResolverClient(t)

		created, err := client.CreateOutpostResolver(t.Context(), &route53resolversdk.CreateOutpostResolverInput{
			CreatorRequestId:      aws.String("cr-outp-1"),
			Name:                  aws.String("outp-1"),
			OutpostArn:            aws.String("arn:aws:outposts:us-east-1:000000000000:outpost/op-11111111"),
	...
	t.Run("query_log_config_family", func(t *testing.T) {
		t.Parallel()
		...
		got, err := client.GetResolverQueryLogConfig(t.Context(), &route53resolversdk.GetResolverQueryLogConfigInput{
		...
		_, err = client.PutResolverQueryLogConfigPolicy(
			...
			&route53resolversdk.PutResolverQueryLogConfigPolicyInput{
				...
				ResolverQueryLogConfigPolicy: aws.String(
					slice16Policy("route53resolver:AssociateResolverQueryLogConfig", qlcARN),
				),
			},
		)
		require.NoError(t, err)
		...
		_, err = client.DeleteResolverQueryLogConfig(t.Context(), &route53resolversdk.DeleteResolverQueryLogConfigInput{
			ResolverQueryLogConfigId: aws.String(qlcID),
		})
		require.NoError(t, err)

		_, err = client.GetResolverQueryLogConfig(t.Context(), &route53resolversdk.GetResolverQueryLogConfigInput{
			ResolverQueryLogConfigId: aws.String(qlcID),
		})
		require.Error(t, err)
	})

	t.Run("query_log_association_family", func(t *testing.T) {
		t.Parallel()
		...
		require.NoError(t, err)
		assert.Equal(t, qlcID, aws.ToString(gotAssoc.ResolverQueryLogConfigAssociation.ResolverQueryLogConfigId))
	...
	t.Run("resolver_rule_family", func(t *testing.T) {
		t.Parallel()
		...
		_, err = client.PutResolverRulePolicy(t.Context(), &route53resolversdk.PutResolverRulePolicyInput{
			...
			ResolverRulePolicy: aws.String(
				slice16Policy("route53resolver:GetResolverRule", ruleARN),
			),
		})
		require.NoError(t, err)
		...
		associated, err := client.AssociateResolverRule(t.Context(), &route53resolversdk.AssociateResolverRuleInput{
			ResolverRuleId: aws.String(ruleID),
