...
// TestCodePipeline_TypedSlice25 drives every remaining uncovered op through
...
// UpdateActionType.
func TestCodePipeline_TypedSlice25(t *testing.T) {
	t.Parallel()

	t.Run(
		"pipeline execution family: GetPipelineExecution, RollbackStage, EnableStageTransition, rules",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run("job family: PollForJobs, GetJobDetails", func(t *testing.T) {
		t.Parallel()
	...
	t.Run(
		"custom action type family: GetActionType, UpdateActionType, ListActionTypes",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run("approval and revision family: PutActionRevision, PutApprovalResult", func(t *testing.T) {
		t.Parallel()
	...
	t.Run(
		"webhook family: RegisterWebhookWithThirdParty, DeregisterWebhookWithThirdParty, DeleteWebhook",
		func(t *testing.T) {
			t.Parallel()
	...
	t.Run("tags: TagResource, UntagResource", func(t *testing.T) {
		t.Parallel()
