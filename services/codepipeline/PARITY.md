...
deferred:                 # consciously not audited this pass (scope) — next pass targets
  ...
  - "Cross-service action dispatch (see gaps, 2026-09-04) -- requires a per-ActionTypeId dispatch subsystem into services/lambda, services/s3, services/codebuild, services/codedeploy, etc.; a new subsystem, not audited or scoped further this pass."
...
both are now stored on `Job.FailureMessage`/`Job.FailureType`. The larger residual gap
