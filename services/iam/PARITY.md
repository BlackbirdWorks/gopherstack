...
overall: A   # parity-sweep (2026-09-19): implemented Role Manager (AcquireRole,
  ...
  # templates have no Create/Put/List op in this SDK version at all, so they are
  # seeded only via AddRoleTemplateVersionInternal (role_templates.go), the same
