...
var iamErrorMappings = []iamErrorMapping{
	...
	{ErrAccountAliasNotFound, codeNoSuchEntity, http.StatusNotFound},
	{ErrMFADeviceNotFound, codeNoSuchEntity, http.StatusNotFound},
	{ErrMFADeviceAlreadyEnabled, codeEntityAlreadyExists, http.StatusConflict},
