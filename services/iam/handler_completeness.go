...
//nolint:dupl // tag dispatch functions share the same structure by design
...
//nolint:funlen // returns all server cert operations in one map
...
func (h *Handler) iamSSHSigningDispatch() map[string]iamActionFn {
	return map[string]iamActionFn{
		...
		"ListSigningCertificates": func(_ url.Values, reqID string) (any, error) {
			return &listSigningCertificatesResponse{
				...
				ListSigningCertificatesResult: listSigningCertificatesResult{
					Certificates: []signingCertXML{},
					IsTruncated:  false,
				},
				ResponseMetadata: ResponseMetadata{RequestID: reqID},
			}, nil
		},
		"DeleteSigningCertificate": func(_ url.Values, reqID string) (any, error) {
			return &iamSimpleTagResponse{
		...
		"UpdateSigningCertificate": func(_ url.Values, reqID string) (any, error) {
			return &iamSimpleTagResponse{
			...
			return &uploadSigningCertificateResponse{
				...
				UploadSigningCertificateResult: uploadSigningCertificateResult{
					Certificate: signingCertXML{
						CertificateID:   "ASCA" + userName,
						UserName:        userName,
						CertificateBody: vals.Get("CertificateBody"),
						Status:          accessKeyStatusActive,
						UploadDate:      isoTime(time.Now()),
					},
				},
