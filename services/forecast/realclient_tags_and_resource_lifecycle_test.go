...
// TestRealClient_TagsAndResourceLifecycle covers forecast's last four typed-client-
// uncovered ops (gopherstack-n3zi): TagResource, UntagResource,
// ResumeResource, DeleteResourceTree.
func TestRealClient_TagsAndResourceLifecycle(t *testing.T) {
	t.Parallel()
	ctx := t.Context()
