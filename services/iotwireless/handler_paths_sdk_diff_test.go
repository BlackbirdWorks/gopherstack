...
// did not fall through to the "unknown operation" error that dispatch's
// final default emits (handler.go:480) -- guarding against an operation
// name that resolves correctly but has no matching case in either
// dispatchCoreOps or dispatchTagOps (gopherstack-ey26).
