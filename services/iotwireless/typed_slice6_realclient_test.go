...
// TestSlice6_IoTWireless_RealClient covers iotwireless's highest-priority
// typed-client-uncovered op families (gopherstack-n3zi slice 6): wireless
...
func TestSlice6_IoTWireless_RealClient(t *testing.T) {
	t.Parallel()
