...
// TestRealClient_Pagination proves, against the real typed
...
// for awsconfig (gopherstack-xhu2t) are now read and actually applied
...
// behave observably.
func TestRealClient_Pagination(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{testAggregationAuthorizationsPagination, "aggregation_authorizations"},
		{testConfigurationAggregatorsPagination, "configuration_aggregators"},
		{testAggregatorSourcesStatusPagination, "aggregator_sources_status"},
		{testPendingAggregationRequestsPagination, "pending_aggregation_requests"},
		{testConfigRuleEvaluationStatusPagination, "config_rule_evaluation_status"},
		{testComplianceDetailsByConfigRulePagination, "compliance_details_by_config_rule"},
		{testComplianceByResourcePagination, "compliance_by_resource"},
		{testRemediationExceptionsPagination, "remediation_exceptions"},
		{testRemediationExecutionStatusPagination, "remediation_execution_status"},
		{testOrganizationConfigRulesPagination, "organization_config_rules"},
		{testOrganizationConformancePacksPagination, "organization_conformance_packs"},
		{testAggregateComplianceByConfigRulesPagination, "aggregate_compliance_by_config_rules"},
		{testAggregateComplianceByConformancePacksPagination, "aggregate_compliance_by_conformance_packs"},
		{testConformancePackComplianceDetailsPagination, "conformance_pack_compliance_details"},
		{testConformancePackComplianceScoresSort, "conformance_pack_compliance_scores_sort"},
		{testListAggregateDiscoveredResourcesPagination, "list_aggregate_discovered_resources"},
		{testListDiscoveredResourcesPagination, "list_discovered_resources"},
		{testListResourceEvaluationsPagination, "list_resource_evaluations"},
		{testListTagsForResourcePagination, "list_tags_for_resource"},
		{testResourceConfigHistoryOrderAndTimeRange, "resource_config_history_order_and_time_range"},
	}
...
func newBackend(t *testing.T) (*awsconfig.InMemoryBackend, *configservicesdk.Client) {
	t.Helper()
...
func testAggregationAuthorizationsPagination(t *testing.T) {
	t.Helper()
...
func testConfigurationAggregatorsPagination(t *testing.T) {
	t.Helper()
...
func testAggregatorSourcesStatusPagination(t *testing.T) {
	t.Helper()
...
func testPendingAggregationRequestsPagination(t *testing.T) {
	t.Helper()
...
func putConfigRule(t *testing.T, backend *awsconfig.InMemoryBackend, name string) {
	t.Helper()
...
func testConfigRuleEvaluationStatusPagination(t *testing.T) {
	t.Helper()

	backend, client := newBackend(t)
	ctx := t.Context()

	putConfigRule(t, backend, "rule-a")
	putConfigRule(t, backend, "rule-b")
...
func testComplianceDetailsByConfigRulePagination(t *testing.T) {
	t.Helper()

	backend, client := newBackend(t)
	ctx := t.Context()

	putConfigRule(t, backend, "rule-details")
	require.NoError(t, backend.PutEvaluations([]awsconfig.EvaluationResult{
		{
...
func testComplianceByResourcePagination(t *testing.T) {
	t.Helper()

	backend, client := newBackend(t)
	ctx := t.Context()

	putConfigRule(t, backend, "rule-by-resource")
	require.NoError(t, backend.PutEvaluations([]awsconfig.EvaluationResult{
		{
...
func testRemediationExceptionsPagination(t *testing.T) {
	t.Helper()

	backend, client := newBackend(t)
	ctx := t.Context()

	putConfigRule(t, backend, "rule-exceptions")
...
func testRemediationExecutionStatusPagination(t *testing.T) {
	t.Helper()

	backend, client := newBackend(t)
	ctx := t.Context()

	putConfigRule(t, backend, "rule-exec-status")
...
func testOrganizationConfigRulesPagination(t *testing.T) {
	t.Helper()
...
func testOrganizationConformancePacksPagination(t *testing.T) {
	t.Helper()
...
func testAggregateComplianceByConfigRulesPagination(t *testing.T) {
	t.Helper()
	...
	putConfigRule(t, backend, "agg-rule-a")
	putConfigRule(t, backend, "agg-rule-b")
	require.NoError(t, backend.PutEvaluations([]awsconfig.EvaluationResult{
		{
...
func testAggregateComplianceByConformancePacksPagination(t *testing.T) {
	t.Helper()
...
func testConformancePackComplianceDetailsPagination(t *testing.T) {
	t.Helper()
...
func testConformancePackComplianceScoresSort(t *testing.T) {
	t.Helper()

	backend, client := newBackend(t)
	ctx := t.Context()

	putConfigRule(t, backend, "score-rule-low")
	putConfigRule(t, backend, "score-rule-high")
...
func testListAggregateDiscoveredResourcesPagination(t *testing.T) {
	t.Helper()
...
func testListDiscoveredResourcesPagination(t *testing.T) {
	t.Helper()
...
func testListResourceEvaluationsPagination(t *testing.T) {
	t.Helper()
...
func testListTagsForResourcePagination(t *testing.T) {
	t.Helper()

	backend, client := newBackend(t)
	ctx := t.Context()

	putConfigRule(t, backend, "tagged-rule")
...
func testResourceConfigHistoryOrderAndTimeRange(t *testing.T) {
	t.Helper()
