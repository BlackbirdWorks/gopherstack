...
// TestRealClient_ConfigRulesAndRemediation covers awsconfig's highest-priority typed-
// client-uncovered op families (gopherstack-n3zi): recorders/
...
// values.
func TestRealClient_ConfigRulesAndRemediation(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{testRecordersDeliveryRealClient, "recorders_delivery"},
		{testConfigRulesComplianceRealClient, "config_rules_compliance"},
		{testConformancePacksRealClient, "conformance_packs"},
		{testRemediationRealClient, "remediation"},
		{testAggregatorsRealClient, "aggregators_authorizations"},
		{testResourceConfigRealClient, "resource_config_history_select"},
		{testRetentionRealClient, "retention"},
		{testStoredQueriesRealClient, "stored_queries"},
		{testOrganizationRealClient, "organization_rules_packs"},
		{testConnectorsRealClient, "connectors"},
		{testTagsRealClient, "tags"},
		{testResourceEvaluationRealClient, "resource_evaluation"},
	}
...
func testRecordersDeliveryRealClient(t *testing.T) {
	t.Helper()
...
func testConfigRulesComplianceRealClient(t *testing.T) {
	t.Helper()
...
func testConformancePacksRealClient(t *testing.T) {
	t.Helper()
...
func testRemediationRealClient(t *testing.T) {
	t.Helper()
...
func testAggregatorsRealClient(t *testing.T) {
	t.Helper()
...
func testResourceConfigRealClient(t *testing.T) {
	t.Helper()
...
func testRetentionRealClient(t *testing.T) {
	t.Helper()
...
func testStoredQueriesRealClient(t *testing.T) {
	t.Helper()
...
func testResourceEvaluationRealClient(t *testing.T) {
	t.Helper()
