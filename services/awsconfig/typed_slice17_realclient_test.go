...
// TestSlice17_AWSConfig_RealClient covers awsconfig's last seven typed-
// client-uncovered ops (gopherstack-n3zi slice 17): the three service-linked
// configuration recorder ops and the four aggregate-compliance read ops.
func TestSlice17_AWSConfig_RealClient(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{testSlice17ServiceLinkedRecordersRealClient, "service_linked_recorders"},
		{testSlice17ThirdPartyServiceLinkedRecorderRealClient, "third_party_service_linked_recorder"},
		{testSlice17AggregateComplianceRealClient, "aggregate_compliance"},
	}
...
func testSlice17ServiceLinkedRecordersRealClient(t *testing.T) {
	t.Helper()
...
func testSlice17ThirdPartyServiceLinkedRecorderRealClient(t *testing.T) {
	t.Helper()
...
func testSlice17AggregateComplianceRealClient(t *testing.T) {
	t.Helper()
