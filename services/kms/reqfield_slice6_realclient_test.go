...
// Test_Slice6_EncryptionAlgorithm drives Encrypt/Decrypt/ReEncrypt's
// EncryptionAlgorithm(s) fields (reqfielddiff slice 6, gopherstack-xhu2t)
// through the real client. Previously these fields were entirely undeclared:
...
func Test_Slice6_EncryptionAlgorithm(t *testing.T) {
	t.Parallel()

	t.Run("encrypt_honors_requested_rsa_algorithm", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("encrypt_rejects_algorithm_not_valid_for_key", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("decrypt_rejects_algorithm_not_valid_for_key", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("reencrypt_honors_both_requested_algorithms", func(t *testing.T) {
		t.Parallel()
...
// Test_Slice6_GetKeyPolicyPolicyName proves GetKeyPolicy now rejects a
...
func Test_Slice6_GetKeyPolicyPolicyName(t *testing.T) {
	t.Parallel()
...
// Test_Slice6_PutKeyPolicyBypassLockoutSafetyCheck proves
...
func Test_Slice6_PutKeyPolicyBypassLockoutSafetyCheck(t *testing.T) {
	t.Parallel()
