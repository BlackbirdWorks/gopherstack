...
func newRealClient(t *testing.T) (*organizationssdk.Client, *organizationssdk.CreateOrganizationOutput) {
	t.Helper()
...
// TestRealClient_AccountLifecycle drives CreateAccount, DescribeCreateAccountStatus,
// ListCreateAccountStatus, MoveAccount, ListAccountsForParent and CloseAccount.
func TestRealClient_AccountLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_RemoveAccountFromOrganization drives RemoveAccountFromOrganization.
func TestRealClient_RemoveAccountFromOrganization(t *testing.T) {
	t.Parallel()
...
// TestRealClient_CreateGovCloudAccount drives CreateGovCloudAccount.
func TestRealClient_CreateGovCloudAccount(t *testing.T) {
	t.Parallel()
...
// TestRealClient_OrganizationalUnitLifecycle drives ListChildren, ListParents
// and UpdateOrganizationalUnit.
func TestRealClient_OrganizationalUnitLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_PolicyLifecycle drives Describe/Update/DeletePolicy,
// Attach/DetachPolicy, ListPolicies, ListPoliciesForTarget and
// ListTargetsForPolicy.
func TestRealClient_PolicyLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_PolicyTypeToggle drives EnablePolicyType and DisablePolicyType.
func TestRealClient_PolicyTypeToggle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ServiceAccessAndDelegatedAdmin drives EnableAWSServiceAccess,
...
func TestRealClient_ServiceAccessAndDelegatedAdmin(t *testing.T) {
	t.Parallel()
...
// TestRealClient_HandshakeLifecycle drives DescribeHandshake, CancelHandshake,
// DeclineHandshake, ListHandshakesForAccount and ListHandshakesForOrganization.
func TestRealClient_HandshakeLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_LeaveOrganization proves LeaveOrganization fails from the
...
// b.accountID).
func TestRealClient_LeaveOrganization(t *testing.T) {
	t.Parallel()
...
// TestRealClient_EnableAllFeatures drives EnableAllFeatures.
func TestRealClient_EnableAllFeatures(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ResourcePolicy drives Put/Describe/DeleteResourcePolicy.
...
// TestRealClient_EffectivePolicy drives DescribeEffectivePolicy and
// ListAccountsWithInvalidEffectivePolicy.
func TestRealClient_EffectivePolicy(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ResourceTags drives TagResource and UntagResource against a
