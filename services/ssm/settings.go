...
type Settings struct {
	...
	CommandTTL      time.Duration `json:"command_ttl"      env:"SSM_COMMAND_TTL"      default:"1h"  help:"TTL for SendCommand results before they expire (matches AWS 1h default)."` //nolint:lll // Kong struct tag makes this line long
}
