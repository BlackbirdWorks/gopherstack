...
ops:
  ...
  DescribeInventoryDeletions: {wire: ok, errors: ok, state: ok, persist: ok, note: "re-verified, matches. FIXED this pass — same epoch-seconds bug, InventoryDeletion.DeletionStartTime"}
