...
**Parity grade: A** · SDK `aws-sdk-go-v2/service/ssm@v1.77.0` · last audited 2026-09-18 (`6cce41004`)
...
- "UpdatePatchBaselineInput.Replace is unmodeled, same class as UpdateAssociation's replace-semantics gap (needs pointer fields, would ripple through merge-semantics tests); CreatePatchBaselineInput.ClientToken (idempotency) is low-value and unmodeled."
