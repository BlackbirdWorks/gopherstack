...
// TestRealClient_ReqFieldWiring proves the gopherstack-xhu2t
...
// (see the gopherstack-xhu2t note in PARITY.md), and by this file's own
...
func TestRealClient_ReqFieldWiring(t *testing.T) {
	t.Parallel()
...
func newRealClient(t *testing.T) *ssmsdk.Client {
	t.Helper()
