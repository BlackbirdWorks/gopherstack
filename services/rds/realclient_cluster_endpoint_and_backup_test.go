...
// TestRealClient_ClusterEndpointAndBackup covers four of rds's five typed-client-
// uncovered ops (gopherstack-n3zi): DisableHttpEndpoint,
...
func TestRealClient_ClusterEndpointAndBackup(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{testDisableHTTPEndpointRealClient, "disable_http_endpoint"},
		{testModifyDBClusterEndpointRealClient, "modify_db_cluster_endpoint"},
		{testModifyDBRecommendationRealClient, "modify_db_recommendation"},
		{testDeleteDBInstanceAutomatedBackupRealClient, "delete_db_instance_automated_backup"},
	}
...
func testDisableHTTPEndpointRealClient(t *testing.T) {
	t.Helper()
...
func testModifyDBClusterEndpointRealClient(t *testing.T) {
	t.Helper()
...
func testModifyDBRecommendationRealClient(t *testing.T) {
	t.Helper()
...
func testDeleteDBInstanceAutomatedBackupRealClient(t *testing.T) {
	t.Helper()
