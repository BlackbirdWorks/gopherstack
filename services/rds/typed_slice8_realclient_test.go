...
// TestSlice8_RDS_RealClient covers rds's highest-priority typed-client-
// uncovered op families (gopherstack-n3zi slice 8): instance/cluster
...
func TestSlice8_RDS_RealClient(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{testSlice8InstanceLifecycleRealClient, "instance_lifecycle"},
		{testSlice8ReadReplicaRealClient, "read_replica"},
		{testSlice8ClusterLifecycleRealClient, "cluster_lifecycle"},
		{testSlice8SecurityGroupsRealClient, "security_groups"},
		{testSlice8ParameterGroupsRealClient, "parameter_groups"},
		{testSlice8OptionGroupsRealClient, "option_groups"},
		{testSlice8SubnetGroupRealClient, "subnet_group"},
		{testSlice8EventSubscriptionsRealClient, "event_subscriptions"},
		{testSlice8SnapshotsRealClient, "snapshots"},
		{testSlice8GlobalClusterBlueGreenRealClient, "global_cluster_blue_green"},
		{testSlice8ShardGroupTenantIntegrationRealClient, "shard_group_tenant_integration"},
		{testSlice8ReservedInstancesReferenceDataRealClient, "reserved_instances_reference_data"},
		{testSlice8AutomatedBackupsRealClient, "automated_backups"},
		{testSlice8CustomEngineVersionRealClient, "custom_engine_version"},
	}
...
func newSlice8RDSBackendAndClient(t *testing.T) (*rds.InMemoryBackend, *rdssdk.Client) {
	t.Helper()
...
func testSlice8InstanceLifecycleRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8ReadReplicaRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8ClusterLifecycleRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8SecurityGroupsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8ParameterGroupsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8OptionGroupsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8SubnetGroupRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8EventSubscriptionsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8SnapshotsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8GlobalClusterBlueGreenRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8ShardGroupTenantIntegrationRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8ReservedInstancesReferenceDataRealClient(t *testing.T) {
	t.Helper()

	_, client := newSlice8RDSBackendAndClient(t)
	ctx := t.Context()
...
func testSlice8AutomatedBackupsRealClient(t *testing.T) {
	t.Helper()
...
func testSlice8CustomEngineVersionRealClient(t *testing.T) {
	t.Helper()
