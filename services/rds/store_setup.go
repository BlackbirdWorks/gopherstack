...
//   - clusterRoles: map[string][]DBClusterRole, slice-valued, FeatureName tracked per
//     association (optional on the wire; see db_clusters.go/gopherstack-1jkv for the
//     documented omitted-FeatureName placeholder)
