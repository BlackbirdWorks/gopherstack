...
// TestRealClient_ClusterTaskAndServiceManagement drives ecs's typed-coverage-blind ops
// (gopherstack-n3zi) through the real aws-sdk-go-v2 client.
func TestRealClient_ClusterTaskAndServiceManagement(t *testing.T) {
	t.Parallel()
	cases := []struct {
		run  func(t *testing.T)
		name string
	}{
		{name: "clusters and capacity providers", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "task definitions delete and deregister", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "discover poll endpoint", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "list services by namespace", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "submit agent state changes", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "continue and describe service deployments", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "daemon lifecycle", run: func(t *testing.T) {
			t.Helper()
