...
// TestRealClient_InstanceAndNamespace drives every remaining uncovered op
...
func TestRealClient_InstanceAndNamespace(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
		...
		{
			name: "instance lifecycle: GetInstance, ListInstances, health status, DeregisterInstance",
			run: func(t *testing.T) {
				t.Helper()
		...
		{
			name: "namespace lifecycle: ListNamespaces, UpdateHttpNamespace, DeleteNamespace",
			run: func(t *testing.T) {
				t.Helper()
		...
		{
			name: "service lifecycle: ListServices, UpdateService, DeleteServiceAttributes, DeleteService",
			run: func(t *testing.T) {
				t.Helper()
		...
		{
			name: "Tag and Untag a namespace resource",
			run: func(t *testing.T) {
				t.Helper()
