...
gaps:
  ...
  - "cli.go's wireResourceGroupsTagging covers only ~61 of gopherstack's ~90 services (RegisterProvider/RegisterARNTagger/RegisterARNUntagger for cross-service resource discovery) -- a pre-existing gap, out of this service's scope, tracked separately (bd: gopherstack-3xne)."
