...
// TestTypedSlice15RealClient drives resourcegroupstaggingapi's
...
func TestTypedSlice15RealClient(t *testing.T) {
	...
	t.Run("tag keys and values via a registered provider", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("tag and untag resources", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("compliance summary, required tags, and report creation", func(t *testing.T) {
		t.Parallel()
