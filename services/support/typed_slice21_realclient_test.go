...
// newSlice21SupportClient stands up the real aws-sdk-go-v2 support client
...
func newSlice21SupportClient(t *testing.T) *supportsdk.Client {
	t.Helper()
...
// TestTypedSlice21RealClient drives support's remaining typed-coverage-blind
...
func TestTypedSlice21RealClient(t *testing.T) {
	...
	t.Run("attachments and communications", func(t *testing.T) {
		t.Parallel()

		client := newSlice21SupportClient(t)
		ctx := t.Context()
	...
	t.Run("catalog ops", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("trusted advisor", func(t *testing.T) {
		t.Parallel()
