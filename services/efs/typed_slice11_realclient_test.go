...
// TestTypedSlice11RealClient drives efs's typed-coverage-blind ops
...
func TestTypedSlice11RealClient(t *testing.T) {
	...
	t.Run("tags", func(t *testing.T) {
		...
		//nolint:staticcheck // SA1019: deliberately testing the deprecated-but-real op
	...
	t.Run("account preferences", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("file system policy", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("lifecycle configuration", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("mount target security groups", func(t *testing.T) {
		t.Parallel()
		...
		descOut, err := client.DescribeMountTargetSecurityGroups(ctx, &efssdk.DescribeMountTargetSecurityGroupsInput{
			MountTargetId: aws.String(mtID),
		})
		require.NoError(t, err)
	...
	t.Run("replication configuration delete and file system protection", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("update file system", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("put backup policy", func(t *testing.T) {
		t.Parallel()
