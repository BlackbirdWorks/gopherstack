...
// emrserverless client is either listed in GetSupportedOperations() or explicitly
...
func TestSDKCompleteness(t *testing.T) {
	...
	sdkcheck.CheckCompleteness(t, &emrserverlesssdk.Client{}, h.GetSupportedOperations(), nil)
}
