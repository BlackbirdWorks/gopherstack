...
// TestRealClient_AnomalyMetricAndInsightRules drives cloudwatch's typed-coverage-blind ops
// (gopherstack-n3zi) through the real aws-sdk-go-v2 client.
func TestRealClient_AnomalyMetricAndInsightRules(t *testing.T) {
	t.Parallel()
	cases := []struct {
		run  func(t *testing.T)
		name string
	}{
		{name: "anomaly detector delete", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "metric stream delete", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "insight rules enable disable describe", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "dataset kms key", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "otel enrichment lifecycle", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "get metric data", run: func(t *testing.T) {
			t.Helper()
