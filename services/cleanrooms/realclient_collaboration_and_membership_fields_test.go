...
// TestRealClient_CreateCollaborationFields drives CreateCollaboration's
...
func TestRealClient_CreateCollaborationFields(t *testing.T) {
	t.Parallel()
...
// TestRealClient_CreateMembershipFields drives CreateMembership's
...
func TestRealClient_CreateMembershipFields(t *testing.T) {
	t.Parallel()
...
// TestRealClient_UpdateMembershipFields drives UpdateMembership's
...
func TestRealClient_UpdateMembershipFields(t *testing.T) {
	t.Parallel()
