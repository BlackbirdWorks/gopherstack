...
// TestRealClient_RepositoryLinkAndSyncConfig drives every remaining uncovered op
...
func TestRealClient_RepositoryLinkAndSyncConfig(t *testing.T) {
	t.Parallel()
	cases := []struct {
		run  func(t *testing.T)
		name string
	}{
		{name: "host lifecycle: DeleteHost", run: func(t *testing.T) {
			t.Helper()
