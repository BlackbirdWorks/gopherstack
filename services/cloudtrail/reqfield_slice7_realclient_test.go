...
// TestSlice7_CreateEventDataStore_StartIngestion covers gopherstack-xhu2t
// slice 7: CreateEventDataStoreInput.StartIngestion (default true per
...
func TestSlice7_CreateEventDataStore_StartIngestion(t *testing.T) {
	t.Parallel()
...
// TestSlice7_Trail_IsOrganizationTrail covers gopherstack-xhu2t slice 7:
...
func TestSlice7_Trail_IsOrganizationTrail(t *testing.T) {
	t.Parallel()
