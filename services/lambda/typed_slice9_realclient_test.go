...
// TestTypedSlice9RealClient drives lambda's typed-coverage-blind ops
// (gopherstack-n3zi slice 9) through the real aws-sdk-go-v2 lambda client,
...
func TestTypedSlice9RealClient(t *testing.T) {
	...
	t.Run("code signing configs", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("event invoke config", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("function url configs", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("recursion config", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("runtime management config", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("invoke with response stream", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("event source mapping update", func(t *testing.T) {
		t.Parallel()
