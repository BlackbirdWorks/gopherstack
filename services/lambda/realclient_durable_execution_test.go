...
// TestRealClient_DurableExecution drives lambda's DurableExecution family
// (gopherstack-n3zi) through the real aws-sdk-go-v2 lambda
...
// fabricated backdoor.
func TestRealClient_DurableExecution(t *testing.T) {
	t.Parallel()
