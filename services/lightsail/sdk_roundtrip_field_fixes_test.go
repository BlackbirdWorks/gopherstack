...
// TestRealClient_FieldFixes drives every dropped-parameter fix from the
// reqfielddiff pass through the real aws-sdk-go-v2 client (newTestClient,
// shared with sdk_roundtrip_resource_coverage_test.go) and asserts the
// observable effect of each.
func TestRealClient_FieldFixes(t *testing.T) {
	t.Parallel()
