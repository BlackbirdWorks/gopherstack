...
// TestSlice33_Lightsail_RealClient drives every gopherstack-n3zi
// typed-slice-33 uncovered lightsail op through the real aws-sdk-go-v2
// client (newTestClient, shared with the other sdk_roundtrip_*_test.go
// files).
func TestSlice33_Lightsail_RealClient(t *testing.T) {
	t.Parallel()
