...
families:
  ...
  listener-certificates / ssl-policies / trust-stores (association and revocation add/remove/describe): {status: ok, note: "AddTrustStoreRevocations and DescribeTrustStoreRevocations wire bugs fixed (see ops above); everything else in this family verified correct"}
