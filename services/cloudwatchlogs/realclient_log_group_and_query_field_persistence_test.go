...
// CreateLogGroupInput's DeletionProtectionEnabled (reqfielddiff,
...
// (reqfielddiff, gopherstack-xhu2t) is applied against each log group's real,
...
// gopherstack-xhu2t) apply against each scheduled query's real tracked state.
...
// Baseline field (reqfielddiff, gopherstack-xhu2t) actually moves the anomaly's State
