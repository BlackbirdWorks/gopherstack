...
func newRealClient(t *testing.T) *cwlsdk.Client {
	t.Helper()
...
// TestRealClient_LogGroupsDeliveriesAndPolicies drives cloudwatchlogs's typed-coverage-blind ops
// (gopherstack-n3zi) through the real aws-sdk-go-v2 cloudwatchlogs
// client, one subtest per named priority family, asserting decoded values.
func TestRealClient_LogGroupsDeliveriesAndPolicies(t *testing.T) {
	t.Parallel()
	cases := []struct {
		run  func(t *testing.T)
		name string
	}{
		{name: "log group kms", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "log streams", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "log groups listing and retention", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "log record", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "export tasks", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "import tasks", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "account policies", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "data protection policy delete", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "destinations", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "delivery destinations", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "delivery sources", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "deliveries", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "integrations", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "lookup tables", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "metric filters", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "query definitions", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "index policies and catalogs", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "syslog configurations", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "transformer", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "storage tier policy", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "scheduled queries", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "tags", run: func(t *testing.T) {
			...
			listOut, err := client.ListTagsLogGroup(
				t.Context(),
			...
			listAfter, err := client.ListTagsLogGroup(
				t.Context(),
				&cwlsdk.ListTagsLogGroupInput{LogGroupName: aws.String("/s9/tags")},
			)
			require.NoError(t, err)
		...
		{name: "bearer token authentication", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "log anomaly detector delete", run: func(t *testing.T) {
			t.Helper()
