...
// TestRealClient_AccessPointsAndJobs drives s3control's typed-coverage-blind
// ops (gopherstack-n3zi) through the real aws-sdk-go-v2 s3control
// client, one case per named priority family, asserting decoded values.
func TestRealClient_AccessPointsAndJobs(t *testing.T) {
	t.Parallel()
	...
	cases := []struct {
	...
	}{
		{
			...
			run: func(t *testing.T) {
				...
				_, err = client.PutBucketLifecycleConfiguration(
					t.Context(),
					&s3csdk.PutBucketLifecycleConfigurationInput{
						AccountId: aws.String(acct),
						Bucket:    aws.String("s7-outpost-bucket"),
				...
				replOut, err := client.GetBucketReplication(
					t.Context(),
					&s3csdk.GetBucketReplicationInput{
						AccountId: aws.String(acct),
						Bucket:    aws.String("s7-outpost-bucket"),
					},
				)
				...
				_, err = client.DeleteBucketReplication(
					t.Context(),
					&s3csdk.DeleteBucketReplicationInput{
						AccountId: aws.String(acct),
						Bucket:    aws.String("s7-outpost-bucket"),
					},
				)
		...
		},
		{
			...
			run: func(t *testing.T) {
				...
				_, err := client.CreateAccessPointForObjectLambda(
					t.Context(),
					&s3csdk.CreateAccessPointForObjectLambdaInput{
						AccountId:     aws.String(createTagsTestAccountID),
				...
				getOut, err := client.GetAccessPointForObjectLambda(
					t.Context(),
					&s3csdk.GetAccessPointForObjectLambdaInput{
						AccountId: aws.String(createTagsTestAccountID),
						Name:      aws.String("s7-olap"),
					},
				)
				...
				assert.Equal(
					...
					aws.ToString(fn.Value.FunctionArn),
				)
				...
				_, err = client.DeleteAccessPointForObjectLambda(
					t.Context(),
					&s3csdk.DeleteAccessPointForObjectLambdaInput{
						AccountId: aws.String(createTagsTestAccountID),
						Name:      aws.String("s7-olap"),
					},
				)
		...
		{
			name: "access_point_scope_and_directory",
			run: func(t *testing.T) {
				t.Helper()
		...
		},
		{
			...
			run: func(t *testing.T) {
				...
				createOut, err := client.CreateMultiRegionAccessPoint(
					t.Context(),
				...
				listOut, err := client.ListMultiRegionAccessPoints(
					t.Context(),
					&s3csdk.ListMultiRegionAccessPointsInput{
						AccountId: aws.String(createTagsTestAccountID),
					},
				)
				require.NoError(t, err)
				...
				_, err = client.PutMultiRegionAccessPointPolicy(
					t.Context(),
					&s3csdk.PutMultiRegionAccessPointPolicyInput{
						AccountId:   aws.String(createTagsTestAccountID),
				...
				polOut, err := client.GetMultiRegionAccessPointPolicy(
					t.Context(),
					&s3csdk.GetMultiRegionAccessPointPolicyInput{
						AccountId: aws.String(createTagsTestAccountID),
						Name:      aws.String("s7-mrap"),
					},
				)
				...
				_, err = client.SubmitMultiRegionAccessPointRoutes(
					t.Context(),
					&s3csdk.SubmitMultiRegionAccessPointRoutesInput{
						AccountId: aws.String(createTagsTestAccountID),
		...
		},
		{
			...
			run: func(t *testing.T) {
				...
				_, err = client.PutStorageLensConfigurationTagging(
					t.Context(),
					&s3csdk.PutStorageLensConfigurationTaggingInput{
						AccountId: aws.String(createTagsTestAccountID),
						ConfigId:  aws.String("s7-sl-cfg"),
		...
		},
		{
			...
			run: func(t *testing.T) {
				...
				listInstOut, err := client.ListAccessGrantsInstances(
					t.Context(),
					&s3csdk.ListAccessGrantsInstancesInput{
						AccountId: aws.String(createTagsTestAccountID),
					},
				)
				require.NoError(t, err)
				...
				_, err = client.DeleteAccessGrantsInstanceResourcePolicy(
					t.Context(),
					&s3csdk.DeleteAccessGrantsInstanceResourcePolicyInput{
						AccountId: aws.String(createTagsTestAccountID),
					},
				)
				require.NoError(t, err)
		...
		},
		{
			...
			run: func(t *testing.T) {
				...
				groupARN := "arn:aws:s3:" + createTagsTestRegion + ":" + createTagsTestAccountID +
					":storage-lens-group/s7-tag-group"
