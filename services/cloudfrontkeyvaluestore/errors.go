...
func classifyError(err error) (int, string) {
	switch {
	case errors.Is(err, cloudfrontbackend.ErrKeyValueStoreNotFound), errors.Is(err, cloudfrontbackend.ErrNotFound):
	...
	case errors.Is(err, cloudfrontbackend.ErrValidation), errors.Is(err, errInvalidMaxResults):
