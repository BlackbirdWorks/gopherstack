...
// TestTypedSlice15RealClient drives elb's typed-coverage-blind ops
// (gopherstack-n3zi slice 15) through the real aws-sdk-go-v2 client.
func TestTypedSlice15RealClient(t *testing.T) {
	t.Parallel()

	t.Run("availability zones and attributes and account limits", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("vpc load balancer subnets and security groups", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("describe load balancer policies", func(t *testing.T) {
		t.Parallel()
