...
// TestRealClient_FileSystemAndStorageConfiguration drives fsx's remaining typed-client-blind ops
// through the real aws-sdk-go-v2 client (gopherstack-n3zi).
func TestRealClient_FileSystemAndStorageConfiguration(t *testing.T) {
	t.Parallel()
	cases := []struct {
		...
		{name: "file system aliases and lifecycle ops", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "data repository association update and delete", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "file cache describe update delete", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "storage virtual machine update delete", run: func(t *testing.T) {
			t.Helper()
		...
		{name: "volume update and snapshot update delete", run: func(t *testing.T) {
			t.Helper()
