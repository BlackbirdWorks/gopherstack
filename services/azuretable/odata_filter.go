...
// odata_filter.go implements a hand-written lexer and recursive-descent
// parser for OData's $filter mini-language, modeled on
// services/dynamodb/expr's lexer/parser/evaluator split (see lexer.go,
// parser.go, ast.go, evaluator.go there). odata_filter_eval.go holds the
// evaluator.
//
// Supported grammar:
//
