...
No email-sending subsystem exists to suppress, and no output field echoes this
back, so there's nothing observable to implement. See items_still_open.
