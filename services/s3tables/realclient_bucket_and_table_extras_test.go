...
func newRealClientHandler() *s3tables.Handler {
	return s3tables.NewHandler(s3tables.NewInMemoryBackend("123456789012", "us-east-1"))
}

// TestRealClient_BucketAndTableExtras drives every gopherstack-n3zi typed-slice-33
...
func TestRealClient_BucketAndTableExtras(t *testing.T) {
	t.Parallel()
