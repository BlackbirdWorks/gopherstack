...
// TestRealClient_AccessLifecycle drives Create/Describe/List/Update/DeleteAccess.
func TestRealClient_AccessLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_AgreementLifecycle drives Update/ListAgreements/DeleteAgreement.
...
func TestRealClient_AgreementLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_CertificateLifecycle drives Describe/Update/DeleteCertificate.
func TestRealClient_CertificateLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ConnectorLifecycle drives Describe/List/UpdateConnector,
// TestConnection, StartDirectoryListing, StartRemoteDelete, StartRemoteMove,
// and DeleteConnector.
func TestRealClient_ConnectorLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_HostKeyLifecycle drives Describe/Update/DeleteHostKey.
func TestRealClient_HostKeyLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ProfileLifecycle drives ListProfiles/UpdateProfile/DeleteProfile.
func TestRealClient_ProfileLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_SshPublicKeyLifecycle drives ImportSshPublicKey and
// DeleteSshPublicKey.
func TestRealClient_SshPublicKeyLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_WebAppLifecycle drives Describe/List/UpdateWebApp,
// DeleteWebAppCustomization and DeleteWebApp.
func TestRealClient_WebAppLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_WorkflowLifecycle drives ListWorkflows and DeleteWorkflow.
func TestRealClient_WorkflowLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ListExecutions seeds an execution through the backend's
...
func TestRealClient_ListExecutions(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ServerLifecycle drives StartServer, StopServer and
// UpdateServer. State transitions are asynchronous (100ms delay) so this uses
// require.Eventually rather than a sleep.
func TestRealClient_ServerLifecycle(t *testing.T) {
	t.Parallel()
...
// TestRealClient_TestIdentityProvider drives TestIdentityProvider for
// both a known and an unknown user.
func TestRealClient_TestIdentityProvider(t *testing.T) {
	t.Parallel()
...
// TestRealClient_SecurityPolicies drives DescribeSecurityPolicy and
// ListSecurityPolicies against the static built-in catalog.
func TestRealClient_SecurityPolicies(t *testing.T) {
	t.Parallel()
...
// TestRealClient_UpdateUser drives UpdateUser.
func TestRealClient_UpdateUser(t *testing.T) {
	t.Parallel()
...
// TestRealClient_ResourceTags drives TagResource and UntagResource
