...
// slice34EventConfig is the minimal valid EventConfig every v2 Api (Event API)
// create/update call requires.
func slice34EventConfig() *appsynctypes.EventConfig {
...
// real client, gopherstack-n3zi typed slice 34.
func TestEventAPILifecycle_RealClient(t *testing.T) {
	...
	t.Run("ListApis", func(t *testing.T) {
		...
		created, err := client.CreateApi(t.Context(), &appsyncsdk.CreateApiInput{
			...
			EventConfig: slice34EventConfig(),
		})
	...
	t.Run("ChannelNamespace lifecycle", func(t *testing.T) {
		t.Parallel()
...
func TestMergedAPIAssociationLifecycle_RealClient(t *testing.T) {
	...
	t.Run("AssociateMergedGraphqlApi + DisassociateMergedGraphqlApi", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("AssociateSourceGraphqlApi + UpdateSourceApiAssociation + StartSchemaMerge + DisassociateSourceGraphqlApi",
		func(t *testing.T) {
			t.Parallel()

			assoc, assocErr := client.AssociateSourceGraphqlApi(t.Context(), &appsyncsdk.AssociateSourceGraphqlApiInput{
				MergedApiIdentifier: aws.String(mergedID),
				SourceApiIdentifier: aws.String(sourceID),
...
func TestEvaluationOps_RealClient(t *testing.T) {
	...
	t.Run("EvaluateMappingTemplate", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("EvaluateCode", func(t *testing.T) {
		t.Parallel()
