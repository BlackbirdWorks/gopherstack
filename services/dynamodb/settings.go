...
type Settings struct {
	...
	CreateDelay time.Duration `json:"create_delay" name:"dynamodb-create-delay" env:"DYNAMODB_CREATE_DELAY" default:"0s" help:"Simulated CREATING→ACTIVE delay. 0 disables lifecycle."` //nolint:lll // Kong struct tag makes this line long
	...
	EnforceThroughput bool `json:"enforce_throughput" name:"dynamodb-enforce-throughput" env:"DYNAMODB_ENFORCE_THROUGHPUT" default:"false" help:"Enforce provisioned throughput limits (token bucket per table)."` //nolint:lll // Kong struct tag makes this line long
}
