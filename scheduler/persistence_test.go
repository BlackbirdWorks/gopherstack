...
"snap-schedule",
"rate(5 minutes)",
scheduler.Target{ARN: "arn:aws:lambda:us-east-1:000000000000:function:test", RoleARN: "arn:aws:iam::000000000000:role/test"},
"ENABLED",
scheduler.FlexibleTimeWindow{Mode: "OFF"},
)
require.NoError(t, err)
...
body := `{"Name":"rest-sched","ScheduleExpression":"rate(1 minute)","Target":{"Arn":"arn:aws:lambda:us-east-1:000000000000:function:test","RoleArn":"arn:aws:iam::000000000000:role/test"},"FlexibleTimeWindow":{"Mode":"OFF"},"State":"ENABLED"}`
